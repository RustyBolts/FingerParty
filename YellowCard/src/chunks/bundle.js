...
/**
       ...
       * See the License for the specific language governing permissions and
       * limitations under the License.
       */function X(){return"undefined"==typeof navigator||!navigator||!("onLine"in navigator)||"boolean"!=typeof navigator.onLine||"http:"!==Y()&&"https:"!==Y()&&!d()&&!("connection"in navigator)||navigator.onLine}
/**
       * @license
       * Copyright 2020 Google LLC
       *
       ...
       * limitations under the License.
       */
var Q=function(){function e(e,t){this.shortDelay=e,this.longDelay=t,G(t>e,"Short delay should be less than long delay!"),this.isMobile=p()||l()}return e.prototype.get=function(){return X()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)},e}();
/**
       * @license
       * Copyright 2020 Google LLC
       *
...
/**
       ...
       * See the License for the specific language governing permissions and
       * limitations under the License.
       */function Xe(e){var t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(et(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Qe(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(rt(t))return"Blackberry";if(nt(t))return"Webos";if(Ze(t))return"Safari";if((t.includes("chrome/")||$e(t))&&!t.includes("edge/"))return"Chrome";if(tt(t))return"Android";var r=e.match(/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/);return 2===(null==r?void 0:r.length)?r[1]:"Other"}function Qe(e){return void 0===e&&(e=v()),/firefox\//i.test(e)}function Ze(e){void 0===e&&(e=v());var t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function $e(e){return void 0===e&&(e=v()),/crios\//i.test(e)}function et(e){return void 0===e&&(e=v()),/iemobile/i.test(e)}function tt(e){return void 0===e&&(e=v()),/android/i.test(e)}function rt(e){return void 0===e&&(e=v()),/blackberry/i.test(e)}function nt(e){return void 0===e&&(e=v()),/webos/i.test(e)}function it(e){return void 0===e&&(e=v()),/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function st(e){return void 0===e&&(e=v()),it(e)||tt(e)||nt(e)||rt(e)||/windows phone/i.test(e)||et(e)}
/**
       * @license
       * Copyright 2020 Google LLC
       *
       ...
       * limitations under the License.
       */
function at(e,t){var r;switch(void 0===t&&(t=[]),e){case"Browser":r=Xe(v());break;case"Worker":r=Xe(v())+"-"+e;break;default:r=e}var n=t.length?t.join(","):"FirebaseCore-web";return r+"/JsCore/"+E+"/"+n}
/**
       * @license
...
/**
       ...
       * limitations under the License.
       */
n("firebase","10.9.0","app")}}}));

System.register("chunks:///_virtual/index.esm2017.js",["./rollupPluginModLoBabelHelpers.js","./index.esm20172.js","./index.esm20173.js","./index.esm20175.js","./index.esm20174.js"],(function(e){var t,n,i,r,o,s,a,u,l,h,c,d,f,p,_,v,g,m,y,C,w,T,I,k,b,E,S,N,P,x,R,D,M,F,q,A,L,O,W;return{setters:[function(e){t=e.inheritsLoose,n=e.createForOfIteratorHelperLoose,i=e.createClass,r=e.assertThisInitialized,o=e.asyncToGenerator,s=e.regeneratorRuntime},function(e){a=e.getApp,u=e._getProvider,l=e._registerComponent,h=e.registerVersion,c=e.SDK_VERSION},function(e){d=e.Component},function(e){f=e.stringify,p=e.assert,_=e.Deferred,v=e.contains,g=e.safeGet,m=e.isAdmin,y=e.isValidFormat,C=e.isEmpty,w=e.isMobileCordova,T=e.isReactNative,I=e.assertionError,k=e.base64,b=e.getModularInstance,E=e.getDefaultEmulatorHostnameAndPort,S=e.createMockUserToken,N=e.stringToByteArray,P=e.Sha1,x=e.isNodeSdk,R=e.map,D=e.stringLength,M=e.errorPrefix,F=e.jsonEval,q=e.querystring,A=e.deepCopy,L=e.base64Encode},function(e){O=e.Logger,W=e.LogLevel}],execute:function(){e({_repoManagerDatabaseFromApp:no,_setSDKVersion:z,child:Jr,connectDatabaseEmulator:oo,get:function(e){e=b(e);var t=new Kr((function(){})),n=new Zr(t);return function(e,t,n){var i=function(e,t){var n=t._path,i=null;e.syncPointTree_.foreachOnPath(n,(function(e,t){var r=nt(e,n);i=i||gi(t,r)}));var r=e.syncPointTree_.get(n);r?i=i||gi(r,Ke()):(r=new ci,e.syncPointTree_=e.syncPointTree_.set(n,r));var o=null!=i,s=o?new fn(i,!0,!1):null,a=Mn(e.pendingWriteTree_,t._path);return function(e){return yn(e.viewCache_)}(fi(r,t,a,o?s.getNode():Lt.EMPTY_NODE,o))}(e.serverSyncTree_,t);if(null!=i)return Promise.resolve(i);return e.server_.get(t).then((function(i){var r,o=Wt(i).withIndex(t._queryParams.getIndex());if(Pi(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())r=Ei(e.serverSyncTree_,t._path,o);else{var s=qi(e.serverSyncTree_,t);r=Ni(e.serverSyncTree_,t._path,o,s)}return vr(e.eventQueue_,t._path,r),Si(e.serverSyncTree_,t,n,null,!0),o}),(function(n){return Pr(e,"get for query "+f(t)+" failed: "+n),Promise.reject(new Error(n))}))}(e._repo,e,n).then((function(t){return new $r(t,new Qr(e._repo,e._path),e._queryParams.getIndex())}))},getDatabase:function(e,t){void 0===e&&(e=a());var n=u(e,"database").getImmediate({identifier:t});if(!n._instanceStarted){var i=E("database");i&&oo.apply(void 0,[n].concat(i))}return n},off:function(e,t,n){var i=null,r=n?new Kr(n):null;"value"===t?i=new Zr(r):t&&(i=new eo(t,r));Nr(e._repo,e,i)},onValue:function(e,t,n,i){return function(e,t,n,i,r){var o;"object"==typeof i&&(o=void 0,r=i);"function"==typeof i&&(o=i);if(r&&r.onlyOnce){var s=n,a=function(t,n){Nr(e._repo,e,l),s(t,n)};a.userCallback=n.userCallback,a.context=n.context,n=a}var u=new Kr(n,o||void 0),l="value"===t?new Zr(u):new eo(t,u);return function(e,t,n){var i;i=".info"===Ge(t._path)?Pi(e.infoSyncTree_,t,n):Pi(e.serverSyncTree_,t,n);_r(e.eventQueue_,t._path,i)}(e._repo,e,l),function(){return Nr(e._repo,e,l)}}(e,"value",t,n,i)},push:function(e,t){e=b(e),cr("push",e._path),ur("push",t,e._path,!0);var n,i=wr(e._repo),r=Vr(i),o=Jr(e,r),s=Jr(e,r);n=null!=t?Xr(s,t).then((function(){return s})):Promise.resolve(s);return o.then=n.then.bind(n),o.catch=n.then.bind(n,void 0),o},ref:function(e,t){return(e=b(e))._checkNotDeleted("ref"),void 0!==t?Jr(e._root,t):e._root},set:Xr});var U="@firebase/database",j="1.0.3",H="";function z(e){H=e}
/**
      * @license
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var V,Y=function(){function e(e){this.domStorage_=e,this.prefix_="firebase:"}var t=e.prototype;return t.set=function(e,t){null==t?this.domStorage_.removeItem(this.prefixedName_(e)):this.domStorage_.setItem(this.prefixedName_(e),f(t))},t.get=function(e){var t=this.domStorage_.getItem(this.prefixedName_(e));return null==t?null:F(t)},t.remove=function(e){this.domStorage_.removeItem(this.prefixedName_(e))},t.prefixedName_=function(e){return this.prefix_+e},t.toString=function(){return this.domStorage_.toString()},e}(),B=function(){function e(){this.cache_={},this.isInMemoryStorage=!0}var t=e.prototype;return t.set=function(e,t){null==t?delete this.cache_[e]:this.cache_[e]=t},t.get=function(e){return v(this.cache_,e)?this.cache_[e]:null},t.remove=function(e){delete this.cache_[e]},e}(),K=function(e){try{if("undefined"!=typeof window&&void 0!==window[e]){var t=window[e];return t.setItem("firebase:sentinel","cache"),t.removeItem("firebase:sentinel"),new Y(t)}}catch(e){}return new B},G=K("localStorage"),Q=K("sessionStorage"),$=new O("@firebase/database"),J=(V=1,function(){return V++}),X=function(e){var t=N(e),n=new P;n.update(t);var i=n.digest();return k.encodeByteArray(i)},Z=function e(){for(var t="",n=0;n<arguments.length;n++){var i=n<0||arguments.length<=n?void 0:arguments[n];Array.isArray(i)||i&&"object"==typeof i&&"number"==typeof i.length?t+=e.apply(null,i):t+="object"==typeof i?f(i):i,t+=" "}return t},ee=null,te=!0,ne=function(e,t){p(!t||!0===e||!1===e,"Can't turn on custom loggers persistently."),!0===e?($.logLevel=W.VERBOSE,ee=$.log.bind($),t&&Q.set("logging_enabled",!0)):"function"==typeof e?ee=e:(ee=null,Q.remove("logging_enabled"))},ie=function(){if(!0===te&&(te=!1,null===ee&&!0===Q.get("logging_enabled")&&ne(!0)),ee){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];var i=Z.apply(null,t);ee(i)}},re=function(e){return function(){for(var t=arguments.length,n=new Array(t),i=0;i<t;i++)n[i]=arguments[i];ie.apply(void 0,[e].concat(n))}},oe=function(){var e="FIREBASE INTERNAL ERROR: "+Z.apply(void 0,arguments);$.error(e)},se=function(){var e="FIREBASE FATAL ERROR: "+Z.apply(void 0,arguments);throw $.error(e),new Error(e)},ae=function(){var e="FIREBASE WARNING: "+Z.apply(void 0,arguments);$.warn(e)},ue=function(e){return"number"==typeof e&&(e!=e||e===Number.POSITIVE_INFINITY||e===Number.NEGATIVE_INFINITY)},le="[MIN_NAME]",he="[MAX_NAME]",ce=function(e,t){if(e===t)return 0;if(e===le||t===he)return-1;if(t===le||e===he)return 1;var n=ye(e),i=ye(t);return null!==n?null!==i?n-i==0?e.length-t.length:n-i:-1:null!==i?1:e<t?-1:1},de=function(e,t){return e===t?0:e<t?-1:1},fe=function(e,t){if(t&&e in t)return t[e];throw new Error("Missing required key ("+e+") in object: "+f(t))},pe=function e(t){if("object"!=typeof t||null===t)return f(t);var n=[];for(var i in t)n.push(i);n.sort();for(var r="{",o=0;o<n.length;o++)0!==o&&(r+=","),r+=f(n[o]),r+=":",r+=e(t[n[o]]);return r+="}"},_e=function(e,t){var n=e.length;if(n<=t)return[e];for(var i=[],r=0;r<n;r+=t)r+t>n?i.push(e.substring(r,n)):i.push(e.substring(r,r+t));return i};
/**
      * @license
      * Copyright 2017 Google LLC
      *
...
/**
      ...
      * limitations under the License.
      */
var be=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Ee="websocket",Se="long_polling",Ne=function(){function e(e,t,n,i,r,o,s,a){void 0===r&&(r=!1),void 0===o&&(o=""),void 0===s&&(s=!1),void 0===a&&(a=!1),this.secure=t,this.namespace=n,this.webSocketOnly=i,this.nodeAdmin=r,this.persistenceKey=o,this.includeNamespaceInQueryParams=s,this.isUsingEmulator=a,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=G.get("host:"+e)||this._host}var t=e.prototype;return t.isCacheableHost=function(){return"s-"===this.internalHost.substr(0,2)},t.isCustomHost=function(){return"firebaseio.com"!==this._domain&&"firebaseio-demo.com"!==this._domain},t.toString=function(){var e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e},t.toURLString=function(){var e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?"?ns="+this.namespace:"";return""+e+this.host+"/"+t},i(e,[{key:"host",get:function(){return this._host},set:function(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&G.set("host:"+this._host,this.internalHost))}}]),e}();function Pe(e,t,n){var i;if(p("string"==typeof t,"typeof type must == string"),p("object"==typeof n,"typeof params must == object"),t===Ee)i=(e.secure?"wss://":"ws://")+e.internalHost+"/.ws?";else{if(t!==Se)throw new Error("Unknown connection type: "+t);i=(e.secure?"https://":"http://")+e.internalHost+"/.lp?"}(function(e){return e.host!==e.internalHost||e.isCustomHost()||e.includeNamespaceInQueryParams})(e)&&(n.ns=e.namespace);var r=[];return ve(n,(function(e,t){r.push(e+"="+t)})),i+r.join("&")}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var xe=function(){function e(){this.counters_={}}var t=e.prototype;return t.incrementCounter=function(e,t){void 0===t&&(t=1),v(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t},t.get=function(){return A(this.counters_)},e}(),Re={},De={};
/**
      * @license
      * Copyright 2017 Google LLC
      *
...
/**
      ...
      * limitations under the License.
      */
var je=function(){function e(e){this.initTransports_(e)}var t=e.prototype;return t.initTransports_=function(t){var i=Ue&&Ue.isAvailable(),r=i&&!Ue.previouslyFailed();if(t.webSocketOnly&&(i||ae("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),r=!0),r)this.transports_=[Ue];else{for(var o,s=this.transports_=[],a=n(e.ALL_TRANSPORTS);!(o=a()).done;){var u=o.value;u&&u.isAvailable()&&s.push(u)}e.globalTransportInitialized_=!0}},t.initialTransport=function(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")},t.upgradeTransport=function(){return this.transports_.length>1?this.transports_[1]:null},i(e,null,[{key:"ALL_TRANSPORTS",get:function(){return[Le,Ue]}},{key:"IS_TRANSPORT_INITIALIZED",get:function(){return this.globalTransportInitialized_}}]),e}();je.globalTransportInitialized_=!1;
/**
      * @license
      * Copyright 2017 Google LLC
      *
...
/**
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var ut=function(e){function n(){var t,n,i;return t=e.call(this,["visible"])||this,"undefined"!=typeof document&&void 0!==document.addEventListener&&(void 0!==document.hidden?(i="visibilitychange",n="hidden"):void 0!==document.mozHidden?(i="mozvisibilitychange",n="mozHidden"):void 0!==document.msHidden?(i="msvisibilitychange",n="msHidden"):void 0!==document.webkitHidden&&(i="webkitvisibilitychange",n="webkitHidden")),t.visible_=!0,i&&document.addEventListener(i,(function(){var e=!document[n];e!==t.visible_&&(t.visible_=e,t.trigger("visible",e))}),!1),t}return t(n,e),n.getInstance=function(){return new n},n.prototype.getInitialEvent=function(e){return p("visible"===e,"Unknown event type: "+e),[this.visible_]},n}(Ve),lt=1e3,ht=function(e){function i(t,n,o,s,a,u,l,h){var c;if((c=e.call(this)||this).repoInfo_=t,c.applicationId_=n,c.onDataUpdate_=o,c.onConnectStatus_=s,c.onServerInfoUpdate_=a,c.authTokenProvider_=u,c.appCheckTokenProvider_=l,c.authOverride_=h,c.id=i.nextPersistentConnectionId_++,c.log_=re("p:"+c.id+":"),c.interruptReasons_={},c.listens=new Map,c.outstandingPuts_=[],c.outstandingGets_=[],c.outstandingPutCount_=0,c.outstandingGetCount_=0,c.onDisconnectRequestQueue_=[],c.connected_=!1,c.reconnectDelay_=lt,c.maxReconnectDelay_=3e5,c.securityDebugCallback_=null,c.lastSessionId=null,c.establishConnectionTimer_=null,c.visible_=!1,c.requestCBHash_={},c.requestNumber_=0,c.realtime_=null,c.authToken_=null,c.appCheckToken_=null,c.forceTokenRefresh_=!1,c.invalidAuthTokenCount_=0,c.invalidAppCheckTokenCount_=0,c.firstConnection_=!0,c.lastConnectionAttemptTime_=null,c.lastConnectionEstablishedTime_=null,h&&!x())throw new Error("Auth override specified in options, but not supported on non Node.js platforms");return ut.getInstance().on("visible",c.onVisible_,r(c)),-1===t.host.indexOf("fblocal")&&Ye.getInstance().on("online",c.onOnline_,r(c)),c}t(i,e);var a=i.prototype;return a.sendRequest=function(e,t,n){var i=++this.requestNumber_,r={r:i,a:e,b:t};this.log_(f(r)),p(this.connected_,"sendRequest call when we're not connected not allowed."),this.realtime_.sendRequest(r),n&&(this.requestCBHash_[i]=n)},a.get=function(e){this.initConnection_();var t=new _,n={action:"g",request:{p:e._path.toString(),q:e._queryObject},onComplete:function(e){var n=e.d;"ok"===e.s?t.resolve(n):t.reject(n)}};this.outstandingGets_.push(n),this.outstandingGetCount_++;var i=this.outstandingGets_.length-1;return this.connected_&&this.sendGet_(i),t.promise},a.listen=function(e,t,n,i){this.initConnection_();var r=e._queryIdentifier,o=e._path.toString();this.log_("Listen called for "+o+" "+r),this.listens.has(o)||this.listens.set(o,new Map),p(e._queryParams.isDefault()||!e._queryParams.loadsAllData(),"listen() called for non-default but complete query"),p(!this.listens.get(o).has(r),"listen() called twice for same path/queryId.");var s={onComplete:i,hashFn:t,query:e,tag:n};this.listens.get(o).set(r,s),this.connected_&&this.sendListen_(s)},a.sendGet_=function(e){var t=this,n=this.outstandingGets_[e];this.sendRequest("g",n.request,(function(i){delete t.outstandingGets_[e],t.outstandingGetCount_--,0===t.outstandingGetCount_&&(t.outstandingGets_=[]),n.onComplete&&n.onComplete(i)}))},a.sendListen_=function(e){var t=this,n=e.query,r=n._path.toString(),o=n._queryIdentifier;this.log_("Listen on "+r+" for "+o);var s={p:r};e.tag&&(s.q=n._queryObject,s.t=e.tag),s.h=e.hashFn(),this.sendRequest("q",s,(function(s){var a=s.d,u=s.s;i.warnOnListenWarnings_(a,n),(t.listens.get(r)&&t.listens.get(r).get(o))===e&&(t.log_("listen response",s),"ok"!==u&&t.removeListen_(r,o),e.onComplete&&e.onComplete(u,a))}))},i.warnOnListenWarnings_=function(e,t){if(e&&"object"==typeof e&&v(e,"w")){var n=g(e,"w");if(Array.isArray(n)&&~n.indexOf("no_index")){var i='".indexOn": "'+t._queryParams.getIndex().toString()+'"',r=t._path.toString();ae("Using an unspecified index. Your data will be downloaded and filtered on the client. Consider adding "+i+" at "+r+" to your security rules for better performance.")}}},a.refreshAuthToken=function(e){this.authToken_=e,this.log_("Auth token refreshed"),this.authToken_?this.tryAuth():this.connected_&&this.sendRequest("unauth",{},(function(){})),this.reduceReconnectDelayIfAdminCredential_(e)},a.reduceReconnectDelayIfAdminCredential_=function(e){(e&&40===e.length||m(e))&&(this.log_("Admin auth credential detected.  Reducing max reconnect time."),this.maxReconnectDelay_=3e4)},a.refreshAppCheckToken=function(e){this.appCheckToken_=e,this.log_("App check token refreshed"),this.appCheckToken_?this.tryAppCheck():this.connected_&&this.sendRequest("unappeck",{},(function(){}))},a.tryAuth=function(){var e=this;if(this.connected_&&this.authToken_){var t=this.authToken_,n=y(t)?"auth":"gauth",i={cred:t};null===this.authOverride_?i.noauth=!0:"object"==typeof this.authOverride_&&(i.authvar=this.authOverride_),this.sendRequest(n,i,(function(n){var i=n.s,r=n.d||"error";e.authToken_===t&&("ok"===i?e.invalidAuthTokenCount_=0:e.onAuthRevoked_(i,r))}))}},a.tryAppCheck=function(){var e=this;this.connected_&&this.appCheckToken_&&this.sendRequest("appcheck",{token:this.appCheckToken_},(function(t){var n=t.s,i=t.d||"error";"ok"===n?e.invalidAppCheckTokenCount_=0:e.onAppCheckRevoked_(n,i)}))},a.unlisten=function(e,t){var n=e._path.toString(),i=e._queryIdentifier;this.log_("Unlisten called for "+n+" "+i),p(e._queryParams.isDefault()||!e._queryParams.loadsAllData(),"unlisten() called for non-default but complete query"),this.removeListen_(n,i)&&this.connected_&&this.sendUnlisten_(n,i,e._queryObject,t)},a.sendUnlisten_=function(e,t,n,i){this.log_("Unlisten on "+e+" for "+t);var r={p:e};i&&(r.q=n,r.t=i),this.sendRequest("n",r)},a.onDisconnectPut=function(e,t,n){this.initConnection_(),this.connected_?this.sendOnDisconnect_("o",e,t,n):this.onDisconnectRequestQueue_.push({pathString:e,action:"o",data:t,onComplete:n})},a.onDisconnectMerge=function(e,t,n){this.initConnection_(),this.connected_?this.sendOnDisconnect_("om",e,t,n):this.onDisconnectRequestQueue_.push({pathString:e,action:"om",data:t,onComplete:n})},a.onDisconnectCancel=function(e,t){this.initConnection_(),this.connected_?this.sendOnDisconnect_("oc",e,null,t):this.onDisconnectRequestQueue_.push({pathString:e,action:"oc",data:null,onComplete:t})},a.sendOnDisconnect_=function(e,t,n,i){var r={p:t,d:n};this.log_("onDisconnect "+e,r),this.sendRequest(e,r,(function(e){i&&setTimeout((function(){i(e.s,e.d)}),Math.floor(0))}))},a.put=function(e,t,n,i){this.putInternal("p",e,t,n,i)},a.merge=function(e,t,n,i){this.putInternal("m",e,t,n,i)},a.putInternal=function(e,t,n,i,r){this.initConnection_();var o={p:t,d:n};void 0!==r&&(o.h=r),this.outstandingPuts_.push({action:e,request:o,onComplete:i}),this.outstandingPutCount_++;var s=this.outstandingPuts_.length-1;this.connected_?this.sendPut_(s):this.log_("Buffering put: "+t)},a.sendPut_=function(e){var t=this,n=this.outstandingPuts_[e].action,i=this.outstandingPuts_[e].request,r=this.outstandingPuts_[e].onComplete;this.outstandingPuts_[e].queued=this.connected_,this.sendRequest(n,i,(function(i){t.log_(n+" response",i),delete t.outstandingPuts_[e],t.outstandingPutCount_--,0===t.outstandingPutCount_&&(t.outstandingPuts_=[]),r&&r(i.s,i.d)}))},a.reportStats=function(e){var t=this;if(this.connected_){var n={c:e};this.log_("reportStats",n),this.sendRequest("s",n,(function(e){if("ok"!==e.s){var n=e.d;t.log_("reportStats","Error sending stats: "+n)}}))}},a.onDataMessage_=function(e){if("r"in e){this.log_("from server: "+f(e));var t=e.r,n=this.requestCBHash_[t];n&&(delete this.requestCBHash_[t],n(e.b))}else{if("error"in e)throw"A server-side error has occurred: "+e.error;"a"in e&&this.onDataPush_(e.a,e.b)}},a.onDataPush_=function(e,t){this.log_("handleServerMessage",e,t),"d"===e?this.onDataUpdate_(t.p,t.d,!1,t.t):"m"===e?this.onDataUpdate_(t.p,t.d,!0,t.t):"c"===e?this.onListenRevoked_(t.p,t.q):"ac"===e?this.onAuthRevoked_(t.s,t.d):"apc"===e?this.onAppCheckRevoked_(t.s,t.d):"sd"===e?this.onSecurityDebugPacket_(t):oe("Unrecognized action received from server: "+f(e)+"\nAre you using the latest client?")},a.onReady_=function(e,t){this.log_("connection ready"),this.connected_=!0,this.lastConnectionEstablishedTime_=(new Date).getTime(),this.handleTimestamp_(e),this.lastSessionId=t,this.firstConnection_&&this.sendConnectStats_(),this.restoreState_(),this.firstConnection_=!1,this.onConnectStatus_(!0)},a.scheduleConnect_=function(e){var t=this;p(!this.realtime_,"Scheduling a connect when we're already connected/ing?"),this.establishConnectionTimer_&&clearTimeout(this.establishConnectionTimer_),this.establishConnectionTimer_=setTimeout((function(){t.establishConnectionTimer_=null,t.establishConnection_()}),Math.floor(e))},a.initConnection_=function(){!this.realtime_&&this.firstConnection_&&this.scheduleConnect_(0)},a.onVisible_=function(e){e&&!this.visible_&&this.reconnectDelay_===this.maxReconnectDelay_&&(this.log_("Window became visible.  Reducing delay."),this.reconnectDelay_=lt,this.realtime_||this.scheduleConnect_(0)),this.visible_=e},a.onOnline_=function(e){e?(this.log_("Browser went online."),this.reconnectDelay_=lt,this.realtime_||this.scheduleConnect_(0)):(this.log_("Browser went offline.  Killing connection."),this.realtime_&&this.realtime_.close())},a.onRealtimeDisconnect_=function(){if(this.log_("data client disconnected"),this.connected_=!1,this.realtime_=null,this.cancelSentTransactions_(),this.requestCBHash_={},this.shouldReconnect_()){if(this.visible_){if(this.lastConnectionEstablishedTime_){(new Date).getTime()-this.lastConnectionEstablishedTime_>3e4&&(this.reconnectDelay_=lt),this.lastConnectionEstablishedTime_=null}}else this.log_("Window isn't visible.  Delaying reconnect."),this.reconnectDelay_=this.maxReconnectDelay_,this.lastConnectionAttemptTime_=(new Date).getTime();var e=(new Date).getTime()-this.lastConnectionAttemptTime_,t=Math.max(0,this.reconnectDelay_-e);t=Math.random()*t,this.log_("Trying to reconnect in "+t+"ms"),this.scheduleConnect_(t),this.reconnectDelay_=Math.min(this.maxReconnectDelay_,1.3*this.reconnectDelay_)}this.onConnectStatus_(!1)},a.establishConnection_=function(){var e=o(s().mark((function e(){var t,n,r,o,a,u,l,h,c,d,f,_,v,g=this;return s().wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(!this.shouldReconnect_()){e.next=29;break}return this.log_("Making a connection attempt"),this.lastConnectionAttemptTime_=(new Date).getTime(),this.lastConnectionEstablishedTime_=null,t=this.onDataMessage_.bind(this),n=this.onReady_.bind(this),r=this.onRealtimeDisconnect_.bind(this),o=this.id+":"+i.nextConnectionId_++,a=this.lastSessionId,u=!1,l=null,h=function(){l?l.close():(u=!0,r())},c=function(e){p(l,"sendRequest call when we're not connected not allowed."),l.sendRequest(e)},this.realtime_={close:h,sendRequest:c},d=this.forceTokenRefresh_,this.forceTokenRefresh_=!1,e.prev=16,e.next=19,Promise.all([this.authTokenProvider_.getToken(d),this.appCheckTokenProvider_.getToken(d)]);case 19:f=e.sent,_=f[0],v=f[1],u?ie("getToken() completed but was canceled"):(ie("getToken() completed. Creating connection."),this.authToken_=_&&_.accessToken,this.appCheckToken_=v&&v.token,l=new He(o,this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,t,n,r,(function(e){ae(e+" ("+g.repoInfo_.toString()+")"),g.interrupt("server_kill")}),a)),e.next=29;break;case 25:e.prev=25,e.t0=e.catch(16),this.log_("Failed to get token: "+e.t0),u||(this.repoInfo_.nodeAdmin&&ae(e.t0),h());case 29:case"end":return e.stop()}}),e,this,[[16,25]])})));return function(){return e.apply(this,arguments)}}(),a.interrupt=function(e){ie("Interrupting connection for reason: "+e),this.interruptReasons_[e]=!0,this.realtime_?this.realtime_.close():(this.establishConnectionTimer_&&(clearTimeout(this.establishConnectionTimer_),this.establishConnectionTimer_=null),this.connected_&&this.onRealtimeDisconnect_())},a.resume=function(e){ie("Resuming connection for reason: "+e),delete this.interruptReasons_[e],C(this.interruptReasons_)&&(this.reconnectDelay_=lt,this.realtime_||this.scheduleConnect_(0))},a.handleTimestamp_=function(e){var t=e-(new Date).getTime();this.onServerInfoUpdate_({serverTimeOffset:t})},a.cancelSentTransactions_=function(){for(var e=0;e<this.outstandingPuts_.length;e++){var t=this.outstandingPuts_[e];t&&"h"in t.request&&t.queued&&(t.onComplete&&t.onComplete("disconnect"),delete this.outstandingPuts_[e],this.outstandingPutCount_--)}0===this.outstandingPutCount_&&(this.outstandingPuts_=[])},a.onListenRevoked_=function(e,t){var n;n=t?t.map((function(e){return pe(e)})).join("$"):"default";var i=this.removeListen_(e,n);i&&i.onComplete&&i.onComplete("permission_denied")},a.removeListen_=function(e,t){var n,i=new Be(e).toString();if(this.listens.has(i)){var r=this.listens.get(i);n=r.get(t),r.delete(t),0===r.size&&this.listens.delete(i)}else n=void 0;return n},a.onAuthRevoked_=function(e,t){ie("Auth token revoked: "+e+"/"+t),this.authToken_=null,this.forceTokenRefresh_=!0,this.realtime_.close(),"invalid_token"!==e&&"permission_denied"!==e||(this.invalidAuthTokenCount_++,this.invalidAuthTokenCount_>=3&&(this.reconnectDelay_=3e4,this.authTokenProvider_.notifyForInvalidToken()))},a.onAppCheckRevoked_=function(e,t){ie("App check token revoked: "+e+"/"+t),this.appCheckToken_=null,this.forceTokenRefresh_=!0,"invalid_token"!==e&&"permission_denied"!==e||(this.invalidAppCheckTokenCount_++,this.invalidAppCheckTokenCount_>=3&&this.appCheckTokenProvider_.notifyForInvalidToken())},a.onSecurityDebugPacket_=function(e){this.securityDebugCallback_?this.securityDebugCallback_(e):"msg"in e&&console.log("FIREBASE: "+e.msg.replace("\n","\nFIREBASE: "))},a.restoreState_=function(){this.tryAuth(),this.tryAppCheck();for(var e,t=n(this.listens.values());!(e=t()).done;)for(var i,r=e.value,o=n(r.values());!(i=o()).done;){var s=i.value;this.sendListen_(s)}for(var a=0;a<this.outstandingPuts_.length;a++)this.outstandingPuts_[a]&&this.sendPut_(a);for(;this.onDisconnectRequestQueue_.length;){var u=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(u.action,u.pathString,u.data,u.onComplete)}for(var l=0;l<this.outstandingGets_.length;l++)this.outstandingGets_[l]&&this.sendGet_(l)},a.sendConnectStats_=function(){var e={};e["sdk.js."+H.replace(/\./g,"-")]=1,w()?e["framework.cordova"]=1:T()&&(e["framework.reactnative"]=1),this.reportStats(e)},a.shouldReconnect_=function(){var e=Ye.getInstance().currentlyOnline();return C(this.interruptReasons_)&&e},i}(ze);
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */ht.nextPersistentConnectionId_=0,ht.nextConnectionId_=0;
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * limitations under the License.
      */
var ct,dt=function(){function e(e,t){this.name=e,this.node=t}return e.Wrap=function(t,n){return new e(t,n)},e}(),ft=function(){function e(){}var t=e.prototype;return t.getCompare=function(){return this.compare.bind(this)},t.indexedValueChanged=function(e,t){var n=new dt(le,e),i=new dt(le,t);return 0!==this.compare(n,i)},t.minPost=function(){return dt.MIN},e}(),pt=function(e){function n(){return e.apply(this,arguments)||this}t(n,e);var r=n.prototype;return r.compare=function(e,t){return ce(e.name,t.name)},r.isDefinedOn=function(e){throw I("KeyIndex.isDefinedOn not expected to be called.")},r.indexedValueChanged=function(e,t){return!1},r.minPost=function(){return dt.MIN},r.maxPost=function(){return new dt(he,ct)},r.makePost=function(e,t){return p("string"==typeof e,"KeyIndex indexValue must always be a string."),new dt(e,ct)},r.toString=function(){return".key"},i(n,null,[{key:"__EMPTY_NODE",get:function(){return ct},set:function(e){ct=e}}]),n}(ft),_t=new pt,vt=function(){function e(e,t,n,i,r){void 0===r&&(r=null),this.isReverse_=i,this.resultGenerator_=r,this.nodeStack_=[];for(var o=1;!e.isEmpty();)if(e=e,o=t?n(e.key,t):1,i&&(o*=-1),o<0)e=this.isReverse_?e.left:e.right;else{if(0===o){this.nodeStack_.push(e);break}this.nodeStack_.push(e),e=this.isReverse_?e.right:e.left}}var t=e.prototype;return t.getNext=function(){if(0===this.nodeStack_.length)return null;var e,t=this.nodeStack_.pop();if(e=this.resultGenerator_?this.resultGenerator_(t.key,t.value):{key:t.key,value:t.value},this.isReverse_)for(t=t.left;!t.isEmpty();)this.nodeStack_.push(t),t=t.right;else for(t=t.right;!t.isEmpty();)this.nodeStack_.push(t),t=t.left;return e},t.hasNext=function(){return this.nodeStack_.length>0},t.peek=function(){if(0===this.nodeStack_.length)return null;var e=this.nodeStack_[this.nodeStack_.length-1];return this.resultGenerator_?this.resultGenerator_(e.key,e.value):{key:e.key,value:e.value}},e}(),gt=function(){function e(t,n,i,r,o){this.key=t,this.value=n,this.color=null!=i?i:e.RED,this.left=null!=r?r:Ct.EMPTY_NODE,this.right=null!=o?o:Ct.EMPTY_NODE}var t=e.prototype;return t.copy=function(t,n,i,r,o){return new e(null!=t?t:this.key,null!=n?n:this.value,null!=i?i:this.color,null!=r?r:this.left,null!=o?o:this.right)},t.count=function(){return this.left.count()+1+this.right.count()},t.isEmpty=function(){return!1},t.inorderTraversal=function(e){return this.left.inorderTraversal(e)||!!e(this.key,this.value)||this.right.inorderTraversal(e)},t.reverseTraversal=function(e){return this.right.reverseTraversal(e)||e(this.key,this.value)||this.left.reverseTraversal(e)},t.min_=function(){return this.left.isEmpty()?this:this.left.min_()},t.minKey=function(){return this.min_().key},t.maxKey=function(){return this.right.isEmpty()?this.key:this.right.maxKey()},t.insert=function(e,t,n){var i=this,r=n(e,i.key);return(i=r<0?i.copy(null,null,null,i.left.insert(e,t,n),null):0===r?i.copy(null,t,null,null,null):i.copy(null,null,null,null,i.right.insert(e,t,n))).fixUp_()},t.removeMin_=function(){if(this.left.isEmpty())return Ct.EMPTY_NODE;var e=this;return e.left.isRed_()||e.left.left.isRed_()||(e=e.moveRedLeft_()),(e=e.copy(null,null,null,e.left.removeMin_(),null)).fixUp_()},t.remove=function(e,t){var n,i;if(t(e,(n=this).key)<0)n.left.isEmpty()||n.left.isRed_()||n.left.left.isRed_()||(n=n.moveRedLeft_()),n=n.copy(null,null,null,n.left.remove(e,t),null);else{if(n.left.isRed_()&&(n=n.rotateRight_()),n.right.isEmpty()||n.right.isRed_()||n.right.left.isRed_()||(n=n.moveRedRight_()),0===t(e,n.key)){if(n.right.isEmpty())return Ct.EMPTY_NODE;i=n.right.min_(),n=n.copy(i.key,i.value,null,null,n.right.removeMin_())}n=n.copy(null,null,null,null,n.right.remove(e,t))}return n.fixUp_()},t.isRed_=function(){return this.color},t.fixUp_=function(){var e=this;return e.right.isRed_()&&!e.left.isRed_()&&(e=e.rotateLeft_()),e.left.isRed_()&&e.left.left.isRed_()&&(e=e.rotateRight_()),e.left.isRed_()&&e.right.isRed_()&&(e=e.colorFlip_()),e},t.moveRedLeft_=function(){var e=this.colorFlip_();return e.right.left.isRed_()&&(e=(e=(e=e.copy(null,null,null,null,e.right.rotateRight_())).rotateLeft_()).colorFlip_()),e},t.moveRedRight_=function(){var e=this.colorFlip_();return e.left.left.isRed_()&&(e=(e=e.rotateRight_()).colorFlip_()),e},t.rotateLeft_=function(){var t=this.copy(null,null,e.RED,null,this.right.left);return this.right.copy(null,null,this.color,t,null)},t.rotateRight_=function(){var t=this.copy(null,null,e.RED,this.left.right,null);return this.left.copy(null,null,this.color,null,t)},t.colorFlip_=function(){var e=this.left.copy(null,null,!this.left.color,null,null),t=this.right.copy(null,null,!this.right.color,null,null);return this.copy(null,null,!this.color,e,t)},t.checkMaxDepth_=function(){var e=this.check_();return Math.pow(2,e)<=this.count()+1},t.check_=function(){if(this.isRed_()&&this.left.isRed_())throw new Error("Red node has red child("+this.key+","+this.value+")");if(this.right.isRed_())throw new Error("Right child of ("+this.key+","+this.value+") is red");var e=this.left.check_();if(e!==this.right.check_())throw new Error("Black depths differ");return e+(this.isRed_()?0:1)},e}();
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */gt.RED=!0,gt.BLACK=!1;var mt,yt=function(){function e(){}var t=e.prototype;return t.copy=function(e,t,n,i,r){return this},t.insert=function(e,t,n){return new gt(e,t,null)},t.remove=function(e,t){return this},t.count=function(){return 0},t.isEmpty=function(){return!0},t.inorderTraversal=function(e){return!1},t.reverseTraversal=function(e){return!1},t.minKey=function(){return null},t.maxKey=function(){return null},t.check_=function(){return 0},t.isRed_=function(){return!1},e}(),Ct=function(){function e(t,n){void 0===n&&(n=e.EMPTY_NODE),this.comparator_=t,this.root_=n}var t=e.prototype;return t.insert=function(t,n){return new e(this.comparator_,this.root_.insert(t,n,this.comparator_).copy(null,null,gt.BLACK,null,null))},t.remove=function(t){return new e(this.comparator_,this.root_.remove(t,this.comparator_).copy(null,null,gt.BLACK,null,null))},t.get=function(e){for(var t,n=this.root_;!n.isEmpty();){if(0===(t=this.comparator_(e,n.key)))return n.value;t<0?n=n.left:t>0&&(n=n.right)}return null},t.getPredecessorKey=function(e){for(var t,n=this.root_,i=null;!n.isEmpty();){if(0===(t=this.comparator_(e,n.key))){if(n.left.isEmpty())return i?i.key:null;for(n=n.left;!n.right.isEmpty();)n=n.right;return n.key}t<0?n=n.left:t>0&&(i=n,n=n.right)}throw new Error("Attempted to find predecessor key for a nonexistent key.  What gives?")},t.isEmpty=function(){return this.root_.isEmpty()},t.count=function(){return this.root_.count()},t.minKey=function(){return this.root_.minKey()},t.maxKey=function(){return this.root_.maxKey()},t.inorderTraversal=function(e){return this.root_.inorderTraversal(e)},t.reverseTraversal=function(e){return this.root_.reverseTraversal(e)},t.getIterator=function(e){return new vt(this.root_,null,this.comparator_,!1,e)},t.getIteratorFrom=function(e,t){return new vt(this.root_,e,this.comparator_,!1,t)},t.getReverseIteratorFrom=function(e,t){return new vt(this.root_,e,this.comparator_,!0,t)},t.getReverseIterator=function(e){return new vt(this.root_,null,this.comparator_,!0,e)},e}();
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * limitations under the License.
      */
function wt(e,t){return ce(e.name,t.name)}function Tt(e,t){return ce(e,t)}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */Ct.EMPTY_NODE=new yt;var It,kt,bt,Et=function(e){return"number"==typeof e?"number:"+ge(e):"string:"+e},St=function(e){if(e.isLeafNode()){var t=e.val();p("string"==typeof t||"number"==typeof t||"object"==typeof t&&v(t,".sv"),"Priority must be a string or number.")}else p(e===mt||e.isEmpty(),"priority of unexpected type.");p(e===mt||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")},Nt=function(){function e(t,n){void 0===n&&(n=e.__childrenNodeConstructor.EMPTY_NODE),this.value_=t,this.priorityNode_=n,this.lazyHash_=null,p(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),St(this.priorityNode_)}var t=e.prototype;return t.isLeafNode=function(){return!0},t.getPriority=function(){return this.priorityNode_},t.updatePriority=function(t){return new e(this.value_,t)},t.getImmediateChild=function(t){return".priority"===t?this.priorityNode_:e.__childrenNodeConstructor.EMPTY_NODE},t.getChild=function(t){return tt(t)?this:".priority"===Ge(t)?this.priorityNode_:e.__childrenNodeConstructor.EMPTY_NODE},t.hasChild=function(){return!1},t.getPredecessorChildName=function(e,t){return null},t.updateImmediateChild=function(t,n){return".priority"===t?this.updatePriority(n):n.isEmpty()&&".priority"!==t?this:e.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(t,n).updatePriority(this.priorityNode_)},t.updateChild=function(t,n){var i=Ge(t);return null===i?n:n.isEmpty()&&".priority"!==i?this:(p(".priority"!==i||1===Qe(t),".priority must be the last token in a path"),this.updateImmediateChild(i,e.__childrenNodeConstructor.EMPTY_NODE.updateChild($e(t),n)))},t.isEmpty=function(){return!1},t.numChildren=function(){return 0},t.forEachChild=function(e,t){return!1},t.val=function(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()},t.hash=function(){if(null===this.lazyHash_){var e="";this.priorityNode_.isEmpty()||(e+="priority:"+Et(this.priorityNode_.val())+":");var t=typeof this.value_;e+=t+":",e+="number"===t?ge(this.value_):this.value_,this.lazyHash_=X(e)}return this.lazyHash_},t.getValue=function(){return this.value_},t.compareTo=function(t){return t===e.__childrenNodeConstructor.EMPTY_NODE?1:t instanceof e.__childrenNodeConstructor?-1:(p(t.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(t))},t.compareToLeafNode_=function(t){var n=typeof t.value_,i=typeof this.value_,r=e.VALUE_TYPE_ORDER.indexOf(n),o=e.VALUE_TYPE_ORDER.indexOf(i);return p(r>=0,"Unknown leaf type: "+n),p(o>=0,"Unknown leaf type: "+i),r===o?"object"===i?0:this.value_<t.value_?-1:this.value_===t.value_?0:1:o-r},t.withIndex=function(){return this},t.isIndexed=function(){return!0},t.equals=function(e){if(e===this)return!0;if(e.isLeafNode()){var t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1},i(e,null,[{key:"__childrenNodeConstructor",get:function(){return It},set:function(e){It=e}}]),e}();Nt.VALUE_TYPE_ORDER=["object","boolean","number","string"];var Pt,xt,Rt=new(function(e){function n(){return e.apply(this,arguments)||this}t(n,e);var i=n.prototype;return i.compare=function(e,t){var n=e.node.getPriority(),i=t.node.getPriority(),r=n.compareTo(i);return 0===r?ce(e.name,t.name):r},i.isDefinedOn=function(e){return!e.getPriority().isEmpty()},i.indexedValueChanged=function(e,t){return!e.getPriority().equals(t.getPriority())},i.minPost=function(){return dt.MIN},i.maxPost=function(){return new dt(he,new Nt("[PRIORITY-POST]",bt))},i.makePost=function(e,t){var n=kt(e);return new dt(t,new Nt("[PRIORITY-POST]",n))},i.toString=function(){return".priority"},n}(ft)),Dt=Math.log(2),Mt=function(){function e(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/Dt,10)),this.current_=this.count-1;var n,i=(n=this.count,parseInt(Array(n+1).join("1"),2));this.bits_=e+1&i}return e.prototype.nextBitIsOne=function(){var e=!(this.bits_&1<<this.current_);return this.current_--,e},e}(),Ft=function(e,t,n,i){e.sort(t);var r=function t(i,r){var o,s,a=r-i;if(0===a)return null;if(1===a)return o=e[i],s=n?n(o):o,new gt(s,o.node,gt.BLACK,null,null);var u=parseInt(a/2,10)+i,l=t(i,u),h=t(u+1,r);return o=e[u],s=n?n(o):o,new gt(s,o.node,gt.BLACK,l,h)},o=function(t){for(var i=null,o=null,s=e.length,a=function(t,i){var o=s-t,a=s;s-=t;var l=r(o+1,a),h=e[o],c=n?n(h):h;u(new gt(c,h.node,i,null,l))},u=function(e){i?(i.left=e,i=e):(o=e,i=e)},l=0;l<t.count;++l){var h=t.nextBitIsOne(),c=Math.pow(2,t.count-(l+1));h?a(c,gt.BLACK):(a(c,gt.BLACK),a(c,gt.RED))}return o}(new Mt(e.length));return new Ct(i||t,o)},qt={},At=function(){function e(e,t){this.indexes_=e,this.indexSet_=t}var t=e.prototype;return t.get=function(e){var t=g(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Ct?t:null},t.hasIndex=function(e){return v(this.indexSet_,e.toString())},t.addIndex=function(t,n){p(t!==_t,"KeyIndex always exists and isn't meant to be added to the IndexMap.");for(var i,r=[],o=!1,s=n.getIterator(dt.Wrap),a=s.getNext();a;)o=o||t.isDefinedOn(a.node),r.push(a),a=s.getNext();i=o?Ft(r,t.getCompare()):qt;var u=t.toString(),l=Object.assign({},this.indexSet_);l[u]=t;var h=Object.assign({},this.indexes_);return h[u]=i,new e(h,l)},t.addToIndexes=function(t,n){var i=this;return new e(R(this.indexes_,(function(e,r){var o=g(i.indexSet_,r);if(p(o,"Missing index implementation for "+r),e===qt){if(o.isDefinedOn(t.node)){for(var s=[],a=n.getIterator(dt.Wrap),u=a.getNext();u;)u.name!==t.name&&s.push(u),u=a.getNext();return s.push(t),Ft(s,o.getCompare())}return qt}var l=n.get(t.name),h=e;return l&&(h=h.remove(new dt(t.name,l))),h.insert(t,t.node)})),this.indexSet_)},t.removeFromIndexes=function(t,n){return new e(R(this.indexes_,(function(e){if(e===qt)return e;var i=n.get(t.name);return i?e.remove(new dt(t.name,i)):e})),this.indexSet_)},i(e,null,[{key:"Default",get:function(){return p(qt&&Rt,"ChildrenNode.ts has not been loaded"),Pt=Pt||new e({".priority":qt},{".priority":Rt})}}]),e}(),Lt=function(){function e(e,t,n){this.children_=e,this.priorityNode_=t,this.indexMap_=n,this.lazyHash_=null,this.priorityNode_&&St(this.priorityNode_),this.children_.isEmpty()&&p(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}var t=e.prototype;return t.isLeafNode=function(){return!1},t.getPriority=function(){return this.priorityNode_||xt},t.updatePriority=function(t){return this.children_.isEmpty()?this:new e(this.children_,t,this.indexMap_)},t.getImmediateChild=function(e){if(".priority"===e)return this.getPriority();var t=this.children_.get(e);return null===t?xt:t},t.getChild=function(e){var t=Ge(e);return null===t?this:this.getImmediateChild(t).getChild($e(e))},t.hasChild=function(e){return null!==this.children_.get(e)},t.updateImmediateChild=function(t,n){if(p(n,"We should always be passing snapshot nodes"),".priority"===t)return this.updatePriority(n);var i,r,o=new dt(t,n);n.isEmpty()?(i=this.children_.remove(t),r=this.indexMap_.removeFromIndexes(o,this.children_)):(i=this.children_.insert(t,n),r=this.indexMap_.addToIndexes(o,this.children_));var s=i.isEmpty()?xt:this.priorityNode_;return new e(i,s,r)},t.updateChild=function(e,t){var n=Ge(e);if(null===n)return t;p(".priority"!==Ge(e)||1===Qe(e),".priority must be the last token in a path");var i=this.getImmediateChild(n).updateChild($e(e),t);return this.updateImmediateChild(n,i)},t.isEmpty=function(){return this.children_.isEmpty()},t.numChildren=function(){return this.children_.count()},t.val=function(t){if(this.isEmpty())return null;var n={},i=0,r=0,o=!0;if(this.forEachChild(Rt,(function(s,a){n[s]=a.val(t),i++,o&&e.INTEGER_REGEXP_.test(s)?r=Math.max(r,Number(s)):o=!1})),!t&&o&&r<2*i){var s=[];for(var a in n)s[a]=n[a];return s}return t&&!this.getPriority().isEmpty()&&(n[".priority"]=this.getPriority().val()),n},t.hash=function(){if(null===this.lazyHash_){var e="";this.getPriority().isEmpty()||(e+="priority:"+Et(this.getPriority().val())+":"),this.forEachChild(Rt,(function(t,n){var i=n.hash();""!==i&&(e+=":"+t+":"+i)})),this.lazyHash_=""===e?"":X(e)}return this.lazyHash_},t.getPredecessorChildName=function(e,t,n){var i=this.resolveIndex_(n);if(i){var r=i.getPredecessorKey(new dt(e,t));return r?r.name:null}return this.children_.getPredecessorKey(e)},t.getFirstChildName=function(e){var t=this.resolveIndex_(e);if(t){var n=t.minKey();return n&&n.name}return this.children_.minKey()},t.getFirstChild=function(e){var t=this.getFirstChildName(e);return t?new dt(t,this.children_.get(t)):null},t.getLastChildName=function(e){var t=this.resolveIndex_(e);if(t){var n=t.maxKey();return n&&n.name}return this.children_.maxKey()},t.getLastChild=function(e){var t=this.getLastChildName(e);return t?new dt(t,this.children_.get(t)):null},t.forEachChild=function(e,t){var n=this.resolveIndex_(e);return n?n.inorderTraversal((function(e){return t(e.name,e.node)})):this.children_.inorderTraversal(t)},t.getIterator=function(e){return this.getIteratorFrom(e.minPost(),e)},t.getIteratorFrom=function(e,t){var n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(function(e){return e}));for(var i=this.children_.getIteratorFrom(e.name,dt.Wrap),r=i.peek();null!=r&&t.compare(r,e)<0;)i.getNext(),r=i.peek();return i},t.getReverseIterator=function(e){return this.getReverseIteratorFrom(e.maxPost(),e)},t.getReverseIteratorFrom=function(e,t){var n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(function(e){return e}));for(var i=this.children_.getReverseIteratorFrom(e.name,dt.Wrap),r=i.peek();null!=r&&t.compare(r,e)>0;)i.getNext(),r=i.peek();return i},t.compareTo=function(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===Ot?-1:0},t.withIndex=function(t){if(t===_t||this.indexMap_.hasIndex(t))return this;var n=this.indexMap_.addIndex(t,this.children_);return new e(this.children_,this.priorityNode_,n)},t.isIndexed=function(e){return e===_t||this.indexMap_.hasIndex(e)},t.equals=function(e){if(e===this)return!0;if(e.isLeafNode())return!1;var t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){for(var n=this.getIterator(Rt),i=t.getIterator(Rt),r=n.getNext(),o=i.getNext();r&&o;){if(r.name!==o.name||!r.node.equals(o.node))return!1;r=n.getNext(),o=i.getNext()}return null===r&&null===o}return!1}return!1},t.resolveIndex_=function(e){return e===_t?null:this.indexMap_.get(e.toString())},i(e,null,[{key:"EMPTY_NODE",get:function(){return xt||(xt=new e(new Ct(Tt),null,At.Default))}}]),e}();Lt.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;var Ot=new(function(e){function n(){return e.call(this,new Ct(Tt),Lt.EMPTY_NODE,At.Default)||this}t(n,e);var i=n.prototype;return i.compareTo=function(e){return e===this?0:1},i.equals=function(e){return e===this},i.getPriority=function(){return this},i.getImmediateChild=function(e){return Lt.EMPTY_NODE},i.isEmpty=function(){return!1},n}(Lt));Object.defineProperties(dt,{MIN:{value:new dt(le,Lt.EMPTY_NODE)},MAX:{value:new dt(he,Ot)}}),pt.__EMPTY_NODE=Lt.EMPTY_NODE,Nt.__childrenNodeConstructor=Lt,mt=Ot,function(e){bt=e}(Ot);function Wt(e,t){if(void 0===t&&(t=null),null===e)return Lt.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),p(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e)return new Nt(e,Wt(t));if(e instanceof Array){var n=Lt.EMPTY_NODE;return ve(e,(function(t,i){if(v(e,t)&&"."!==t.substring(0,1)){var r=Wt(i);!r.isLeafNode()&&r.isEmpty()||(n=n.updateImmediateChild(t,r))}})),n.updatePriority(Wt(t))}var i=[],r=!1;if(ve(e,(function(e,t){if("."!==e.substring(0,1)){var n=Wt(t);n.isEmpty()||(r=r||!n.getPriority().isEmpty(),i.push(new dt(e,n)))}})),0===i.length)return Lt.EMPTY_NODE;var o=Ft(i,wt,(function(e){return e.name}),Tt);if(r){var s=Ft(i,Rt.getCompare());return new Lt(o,Wt(t),new At({".priority":s},{".priority":Rt}))}return new Lt(o,Wt(t),At.Default)}!function(e){kt=e}(Wt);
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * limitations under the License.
      */
var Ut=function(e){function n(t){var n;return(n=e.call(this)||this).indexPath_=t,p(!tt(t)&&".priority"!==Ge(t),"Can't create PathIndex with empty path or .priority key"),n}t(n,e);var i=n.prototype;return i.extractChild=function(e){return e.getChild(this.indexPath_)},i.isDefinedOn=function(e){return!e.getChild(this.indexPath_).isEmpty()},i.compare=function(e,t){var n=this.extractChild(e.node),i=this.extractChild(t.node),r=n.compareTo(i);return 0===r?ce(e.name,t.name):r},i.makePost=function(e,t){var n=Wt(e),i=Lt.EMPTY_NODE.updateChild(this.indexPath_,n);return new dt(t,i)},i.maxPost=function(){var e=Lt.EMPTY_NODE.updateChild(this.indexPath_,Ot);return new dt(he,e)},i.toString=function(){return Xe(this.indexPath_,0).join("/")},n}(ft),jt=new(function(e){function n(){return e.apply(this,arguments)||this}t(n,e);var i=n.prototype;return i.compare=function(e,t){var n=e.node.compareTo(t.node);return 0===n?ce(e.name,t.name):n},i.isDefinedOn=function(e){return!0},i.indexedValueChanged=function(e,t){return!e.equals(t)},i.minPost=function(){return dt.MIN},i.maxPost=function(){return dt.MAX},i.makePost=function(e,t){var n=Wt(e);return new dt(t,n)},i.toString=function(){return".value"},n}(ft));
/**
      * @license
      * Copyright 2017 Google LLC
      *
...
/**
      ...
      * limitations under the License.
      */
function Ht(e){return{type:"value",snapshotNode:e}}function zt(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function Vt(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Yt(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * limitations under the License.
      */
var Bt=function(){function e(e){this.index_=e}var t=e.prototype;return t.updateChild=function(e,t,n,i,r,o){p(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");var s=e.getImmediateChild(t);return s.getChild(i).equals(n.getChild(i))&&s.isEmpty()===n.isEmpty()?e:(null!=o&&(n.isEmpty()?e.hasChild(t)?o.trackChildChange(Vt(t,s)):p(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):s.isEmpty()?o.trackChildChange(zt(t,n)):o.trackChildChange(Yt(t,n,s))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))},t.updateFullNode=function(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(Rt,(function(e,i){t.hasChild(e)||n.trackChildChange(Vt(e,i))})),t.isLeafNode()||t.forEachChild(Rt,(function(t,i){if(e.hasChild(t)){var r=e.getImmediateChild(t);r.equals(i)||n.trackChildChange(Yt(t,i,r))}else n.trackChildChange(zt(t,i))}))),t.withIndex(this.index_)},t.updatePriority=function(e,t){return e.isEmpty()?Lt.EMPTY_NODE:e.updatePriority(t)},t.filtersNodes=function(){return!1},t.getIndexedFilter=function(){return this},t.getIndex=function(){return this.index_},e}(),Kt=function(){function e(t){this.indexedFilter_=new Bt(t.getIndex()),this.index_=t.getIndex(),this.startPost_=e.getStartPost_(t),this.endPost_=e.getEndPost_(t),this.startIsInclusive_=!t.startAfterSet_,this.endIsInclusive_=!t.endBeforeSet_}var t=e.prototype;return t.getStartPost=function(){return this.startPost_},t.getEndPost=function(){return this.endPost_},t.matches=function(e){var t=this.startIsInclusive_?this.index_.compare(this.getStartPost(),e)<=0:this.index_.compare(this.getStartPost(),e)<0,n=this.endIsInclusive_?this.index_.compare(e,this.getEndPost())<=0:this.index_.compare(e,this.getEndPost())<0;return t&&n},t.updateChild=function(e,t,n,i,r,o){return this.matches(new dt(t,n))||(n=Lt.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,n,i,r,o)},t.updateFullNode=function(e,t,n){t.isLeafNode()&&(t=Lt.EMPTY_NODE);var i=t.withIndex(this.index_);i=i.updatePriority(Lt.EMPTY_NODE);var r=this;return t.forEachChild(Rt,(function(e,t){r.matches(new dt(e,t))||(i=i.updateImmediateChild(e,Lt.EMPTY_NODE))})),this.indexedFilter_.updateFullNode(e,i,n)},t.updatePriority=function(e,t){return e},t.filtersNodes=function(){return!0},t.getIndexedFilter=function(){return this.indexedFilter_},t.getIndex=function(){return this.index_},e.getStartPost_=function(e){if(e.hasStart()){var t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}return e.getIndex().minPost()},e.getEndPost_=function(e){if(e.hasEnd()){var t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}return e.getIndex().maxPost()},e}(),Gt=function(){function e(e){var t=this;this.withinDirectionalStart=function(e){return t.reverse_?t.withinEndPost(e):t.withinStartPost(e)},this.withinDirectionalEnd=function(e){return t.reverse_?t.withinStartPost(e):t.withinEndPost(e)},this.withinStartPost=function(e){var n=t.index_.compare(t.rangedFilter_.getStartPost(),e);return t.startIsInclusive_?n<=0:n<0},this.withinEndPost=function(e){var n=t.index_.compare(e,t.rangedFilter_.getEndPost());return t.endIsInclusive_?n<=0:n<0},this.rangedFilter_=new Kt(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft(),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}var t=e.prototype;return t.updateChild=function(e,t,n,i,r,o){return this.rangedFilter_.matches(new dt(t,n))||(n=Lt.EMPTY_NODE),e.getImmediateChild(t).equals(n)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,n,i,r,o):this.fullLimitUpdateChild_(e,t,n,r,o)},t.updateFullNode=function(e,t,n){var i;if(t.isLeafNode()||t.isEmpty())i=Lt.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<t.numChildren()&&t.isIndexed(this.index_)){var r;i=Lt.EMPTY_NODE.withIndex(this.index_),r=this.reverse_?t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);for(var o=0;r.hasNext()&&o<this.limit_;){var s=r.getNext();if(this.withinDirectionalStart(s)){if(!this.withinDirectionalEnd(s))break;i=i.updateImmediateChild(s.name,s.node),o++}}}else{var a;i=(i=t.withIndex(this.index_)).updatePriority(Lt.EMPTY_NODE),a=this.reverse_?i.getReverseIterator(this.index_):i.getIterator(this.index_);for(var u=0;a.hasNext();){var l=a.getNext();u<this.limit_&&this.withinDirectionalStart(l)&&this.withinDirectionalEnd(l)?u++:i=i.updateImmediateChild(l.name,Lt.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,i,n)},t.updatePriority=function(e,t){return e},t.filtersNodes=function(){return!0},t.getIndexedFilter=function(){return this.rangedFilter_.getIndexedFilter()},t.getIndex=function(){return this.index_},t.fullLimitUpdateChild_=function(e,t,n,i,r){var o;if(this.reverse_){var s=this.index_.getCompare();o=function(e,t){return s(t,e)}}else o=this.index_.getCompare();var a=e;p(a.numChildren()===this.limit_,"");var u=new dt(t,n),l=this.reverse_?a.getFirstChild(this.index_):a.getLastChild(this.index_),h=this.rangedFilter_.matches(u);if(a.hasChild(t)){for(var c=a.getImmediateChild(t),d=i.getChildAfterChild(this.index_,l,this.reverse_);null!=d&&(d.name===t||a.hasChild(d.name));)d=i.getChildAfterChild(this.index_,d,this.reverse_);var f=null==d?1:o(d,u);if(h&&!n.isEmpty()&&f>=0)return null!=r&&r.trackChildChange(Yt(t,n,c)),a.updateImmediateChild(t,n);null!=r&&r.trackChildChange(Vt(t,c));var _=a.updateImmediateChild(t,Lt.EMPTY_NODE);return null!=d&&this.rangedFilter_.matches(d)?(null!=r&&r.trackChildChange(zt(d.name,d.node)),_.updateImmediateChild(d.name,d.node)):_}return n.isEmpty()?e:h&&o(l,u)>=0?(null!=r&&(r.trackChildChange(Vt(l.name,l.node)),r.trackChildChange(zt(t,n))),a.updateImmediateChild(t,n).updateImmediateChild(l.name,Lt.EMPTY_NODE)):e},e}(),Qt=e("_QueryParams",function(){function e(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=Rt}var t=e.prototype;return t.hasStart=function(){return this.startSet_},t.isViewFromLeft=function(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_},t.getIndexStartValue=function(){return p(this.startSet_,"Only valid if start has been set"),this.indexStartValue_},t.getIndexStartName=function(){return p(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:le},t.hasEnd=function(){return this.endSet_},t.getIndexEndValue=function(){return p(this.endSet_,"Only valid if end has been set"),this.indexEndValue_},t.getIndexEndName=function(){return p(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:he},t.hasLimit=function(){return this.limitSet_},t.hasAnchoredLimit=function(){return this.limitSet_&&""!==this.viewFrom_},t.getLimit=function(){return p(this.limitSet_,"Only valid if limit has been set"),this.limit_},t.getIndex=function(){return this.index_},t.loadsAllData=function(){return!(this.startSet_||this.endSet_||this.limitSet_)},t.isDefault=function(){return this.loadsAllData()&&this.index_===Rt},t.copy=function(){var t=new e;return t.limitSet_=this.limitSet_,t.limit_=this.limit_,t.startSet_=this.startSet_,t.startAfterSet_=this.startAfterSet_,t.indexStartValue_=this.indexStartValue_,t.startNameSet_=this.startNameSet_,t.indexStartName_=this.indexStartName_,t.endSet_=this.endSet_,t.endBeforeSet_=this.endBeforeSet_,t.indexEndValue_=this.indexEndValue_,t.endNameSet_=this.endNameSet_,t.indexEndName_=this.indexEndName_,t.index_=this.index_,t.viewFrom_=this.viewFrom_,t},e}());
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */function $t(e){var t,n={};if(e.isDefault())return n;if(e.index_===Rt?t="$priority":e.index_===jt?t="$value":e.index_===_t?t="$key":(p(e.index_ instanceof Ut,"Unrecognized index type!"),t=e.index_.toString()),n.orderBy=f(t),e.startSet_){var i=e.startAfterSet_?"startAfter":"startAt";n[i]=f(e.indexStartValue_),e.startNameSet_&&(n[i]+=","+f(e.indexStartName_))}if(e.endSet_){var r=e.endBeforeSet_?"endBefore":"endAt";n[r]=f(e.indexEndValue_),e.endNameSet_&&(n[r]+=","+f(e.indexEndName_))}return e.limitSet_&&(e.isViewFromLeft()?n.limitToFirst=e.limit_:n.limitToLast=e.limit_),n}function Jt(e){var t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_),t.sin=!e.startAfterSet_),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_),t.ein=!e.endBeforeSet_),e.limitSet_){t.l=e.limit_;var n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==Rt&&(t.i=e.index_.toString()),t}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var Xt=function(e){function n(t,n,i,r){var o;return(o=e.call(this)||this).repoInfo_=t,o.onDataUpdate_=n,o.authTokenProvider_=i,o.appCheckTokenProvider_=r,o.log_=re("p:rest:"),o.listens_={},o}t(n,e);var i=n.prototype;return i.reportStats=function(e){throw new Error("Method not implemented.")},n.getListenId_=function(e,t){return void 0!==t?"tag$"+t:(p(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())},i.listen=function(e,t,i,r){var o=this,s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);var a=n.getListenId_(e,i),u={};this.listens_[a]=u;var l=$t(e._queryParams);this.restRequest_(s+".json",l,(function(e,t){var n=t;(404===e&&(n=null,e=null),null===e&&o.onDataUpdate_(s,n,!1,i),g(o.listens_,a)===u)&&r(e?401===e?"permission_denied":"rest_error:"+e:"ok",null)}))},i.unlisten=function(e,t){var i=n.getListenId_(e,t);delete this.listens_[i]},i.get=function(e){var t=this,n=$t(e._queryParams),i=e._path.toString(),r=new _;return this.restRequest_(i+".json",n,(function(e,n){var o=n;404===e&&(o=null,e=null),null===e?(t.onDataUpdate_(i,o,!1,null),r.resolve(o)):r.reject(new Error(o))})),r.promise},i.refreshAuthToken=function(e){},i.restRequest_=function(e,t,n){var i=this;return void 0===t&&(t={}),t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((function(r){var o=r[0],s=r[1];o&&o.accessToken&&(t.auth=o.accessToken),s&&s.token&&(t.ac=s.token);var a=(i.repoInfo_.secure?"https://":"http://")+i.repoInfo_.host+e+"?ns="+i.repoInfo_.namespace+q(t);i.log_("Sending REST request for "+a);var u=new XMLHttpRequest;u.onreadystatechange=function(){if(n&&4===u.readyState){i.log_("REST Response for "+a+" received. status:",u.status,"response:",u.responseText);var e=null;if(u.status>=200&&u.status<300){try{e=F(u.responseText)}catch(e){ae("Failed to parse JSON response for "+a+": "+u.responseText)}n(null,e)}else 401!==u.status&&404!==u.status&&ae("Got unsuccessful REST response for "+a+" Status: "+u.status),n(u.status);n=null}},u.open("GET",a,!0),u.send()}))},n}(ze),Zt=function(){function e(){this.rootNode_=Lt.EMPTY_NODE}var t=e.prototype;return t.getNode=function(e){return this.rootNode_.getChild(e)},t.updateSnapshot=function(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)},e}();
/**
      * @license
      * Copyright 2017 Google LLC
      *
...
/**
      ...
      * limitations under the License.
      */
function en(){return{value:null,children:new Map}}function tn(e,t,n){if(tt(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{var i=Ge(t);e.children.has(i)||e.children.set(i,en()),tn(e.children.get(i),t=$e(t),n)}}function nn(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach((function(e,n){t(n,e)}))}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */(e,(function(e,i){nn(i,new Be(t.toString()+"/"+e),n)}))}var rn,on=function(){function e(e){this.collection_=e,this.last_=null}return e.prototype.get=function(){var e=this.collection_.get(),t=Object.assign({},e);return this.last_&&ve(this.last_,(function(e,n){t[e]=t[e]-n})),this.last_=e,t},e}(),sn=function(){function e(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new on(e);var n=1e4+2e4*Math.random();we(this.reportStats_.bind(this),Math.floor(n))}return e.prototype.reportStats_=function(){var e=this,t=this.statsListener_.get(),n={},i=!1;ve(t,(function(t,r){r>0&&v(e.statsToReport_,t)&&(n[t]=r,i=!0)})),i&&this.server_.reportStats(n),we(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))},e}();
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */function an(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */!function(e){e[e.OVERWRITE=0]="OVERWRITE",e[e.MERGE=1]="MERGE",e[e.ACK_USER_WRITE=2]="ACK_USER_WRITE",e[e.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"}(rn||(rn={}));var un,ln=function(){function e(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=rn.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}return e.prototype.operationForChild=function(t){if(tt(this.path)){if(null!=this.affectedTree.value)return p(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;var n=this.affectedTree.subtree(new Be(t));return new e(Ke(),n,this.revert)}return p(Ge(this.path)===t,"operationForChild called for unrelated child."),new e($e(this.path),this.affectedTree,this.revert)},e}(),hn=function(){function e(e,t){this.source=e,this.path=t,this.type=rn.LISTEN_COMPLETE}return e.prototype.operationForChild=function(t){return tt(this.path)?new e(this.source,Ke()):new e(this.source,$e(this.path))},e}(),cn=function(){function e(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=rn.OVERWRITE}return e.prototype.operationForChild=function(t){return tt(this.path)?new e(this.source,Ke(),this.snap.getImmediateChild(t)):new e(this.source,$e(this.path),this.snap)},e}(),dn=function(){function e(e,t,n){this.source=e,this.path=t,this.children=n,this.type=rn.MERGE}var t=e.prototype;return t.operationForChild=function(t){if(tt(this.path)){var n=this.children.subtree(new Be(t));return n.isEmpty()?null:n.value?new cn(this.source,Ke(),n.value):new e(this.source,Ke(),n)}return p(Ge(this.path)===t,"Can't get a merge for a child not on the path of the operation"),new e(this.source,$e(this.path),this.children)},t.toString=function(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"},e}(),fn=function(){function e(e,t,n){this.node_=e,this.fullyInitialized_=t,this.filtered_=n}var t=e.prototype;return t.isFullyInitialized=function(){return this.fullyInitialized_},t.isFiltered=function(){return this.filtered_},t.isCompleteForPath=function(e){if(tt(e))return this.isFullyInitialized()&&!this.filtered_;var t=Ge(e);return this.isCompleteForChild(t)},t.isCompleteForChild=function(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)},t.getNode=function(){return this.node_},e}(),pn=function(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()};
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */function _n(e,t,n,i,r,o){var s=i.filter((function(e){return e.type===n}));s.sort((function(t,n){return function(e,t,n){if(null==t.childName||null==n.childName)throw I("Should only compare child_ events.");var i=new dt(t.childName,t.snapshotNode),r=new dt(n.childName,n.snapshotNode);return e.index_.compare(i,r)}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */(e,t,n)})),s.forEach((function(n){var i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,o);r.forEach((function(r){r.respondsTo(n.type)&&t.push(r.createEvent(i,e.query_))}))}))}function vn(e,t){return{eventCache:e,serverCache:t}}function gn(e,t,n,i){return vn(new fn(t,n,i),e.serverCache)}function mn(e,t,n,i){return vn(e.eventCache,new fn(t,n,i))}function yn(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Cn(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var wn=function(){function e(e,t){void 0===t&&(un||(un=new Ct(de)),t=un),this.value=e,this.children=t}e.fromObject=function(t){var n=new e(null);return ve(t,(function(e,t){n=n.set(new Be(e),t)})),n};var t=e.prototype;return t.isEmpty=function(){return null===this.value&&this.children.isEmpty()},t.findRootMostMatchingPathAndValue=function(e,t){if(null!=this.value&&t(this.value))return{path:Ke(),value:this.value};if(tt(e))return null;var n=Ge(e),i=this.children.get(n);if(null!==i){var r=i.findRootMostMatchingPathAndValue($e(e),t);return null!=r?{path:et(new Be(n),r.path),value:r.value}:null}return null},t.findRootMostValueAndPath=function(e){return this.findRootMostMatchingPathAndValue(e,(function(){return!0}))},t.subtree=function(t){if(tt(t))return this;var n=Ge(t),i=this.children.get(n);return null!==i?i.subtree($e(t)):new e(null)},t.set=function(t,n){if(tt(t))return new e(n,this.children);var i=Ge(t),r=(this.children.get(i)||new e(null)).set($e(t),n),o=this.children.insert(i,r);return new e(this.value,o)},t.remove=function(t){if(tt(t))return this.children.isEmpty()?new e(null):new e(null,this.children);var n=Ge(t),i=this.children.get(n);if(i){var r,o=i.remove($e(t));return r=o.isEmpty()?this.children.remove(n):this.children.insert(n,o),null===this.value&&r.isEmpty()?new e(null):new e(this.value,r)}return this},t.get=function(e){if(tt(e))return this.value;var t=Ge(e),n=this.children.get(t);return n?n.get($e(e)):null},t.setTree=function(t,n){if(tt(t))return n;var i,r=Ge(t),o=(this.children.get(r)||new e(null)).setTree($e(t),n);return i=o.isEmpty()?this.children.remove(r):this.children.insert(r,o),new e(this.value,i)},t.fold=function(e){return this.fold_(Ke(),e)},t.fold_=function(e,t){var n={};return this.children.inorderTraversal((function(i,r){n[i]=r.fold_(et(e,i),t)})),t(e,this.value,n)},t.findOnPath=function(e,t){return this.findOnPath_(e,Ke(),t)},t.findOnPath_=function(e,t,n){var i=!!this.value&&n(t,this.value);if(i)return i;if(tt(e))return null;var r=Ge(e),o=this.children.get(r);return o?o.findOnPath_($e(e),et(t,r),n):null},t.foreachOnPath=function(e,t){return this.foreachOnPath_(e,Ke(),t)},t.foreachOnPath_=function(t,n,i){if(tt(t))return this;this.value&&i(n,this.value);var r=Ge(t),o=this.children.get(r);return o?o.foreachOnPath_($e(t),et(n,r),i):new e(null)},t.foreach=function(e){this.foreach_(Ke(),e)},t.foreach_=function(e,t){this.children.inorderTraversal((function(n,i){i.foreach_(et(e,n),t)})),this.value&&t(e,this.value)},t.foreachChild=function(e){this.children.inorderTraversal((function(t,n){n.value&&e(t,n.value)}))},e}(),Tn=function(){function e(e){this.writeTree_=e}return e.empty=function(){return new e(new wn(null))},e}();function In(e,t,n){if(tt(t))return new Tn(new wn(n));var i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){var r=i.path,o=i.value,s=nt(r,t);return o=o.updateChild(s,n),new Tn(e.writeTree_.set(r,o))}var a=new wn(n),u=e.writeTree_.setTree(t,a);return new Tn(u)}function kn(e,t,n){var i=e;return ve(n,(function(e,n){i=In(i,et(t,e),n)})),i}function bn(e,t){if(tt(t))return Tn.empty();var n=e.writeTree_.setTree(t,new wn(null));return new Tn(n)}function En(e,t){return null!=Sn(e,t)}function Sn(e,t){var n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(nt(n.path,t)):null}function Nn(e){var t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Rt,(function(e,n){t.push(new dt(e,n))})):e.writeTree_.children.inorderTraversal((function(e,n){null!=n.value&&t.push(new dt(e,n.value))})),t}function Pn(e,t){if(tt(t))return e;var n=Sn(e,t);return new Tn(null!=n?new wn(n):e.writeTree_.subtree(t))}function xn(e){return e.writeTree_.isEmpty()}function Rn(e,t){return Dn(Ke(),e.writeTree_,t)}function Dn(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);var i=null;return t.children.inorderTraversal((function(t,r){".priority"===t?(p(null!==r.value,"Priority writes must always be leaf nodes"),i=r.value):n=Dn(et(e,t),r,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(et(e,".priority"),i)),n}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */function Mn(e,t){return Bn(t,e)}function Fn(e,t){var n=e.allWrites.findIndex((function(e){return e.writeId===t}));p(n>=0,"removeWrite called with nonexistent writeId.");var i=e.allWrites[n];e.allWrites.splice(n,1);for(var r=i.visible,o=!1,s=e.allWrites.length-1;r&&s>=0;){var a=e.allWrites[s];a.visible&&(s>=n&&qn(a,i.path)?r=!1:rt(i.path,a.path)&&(o=!0)),s--}if(r){if(o)return function(e){e.visibleWrites=Ln(e.allWrites,An,Ke()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;i.snap?e.visibleWrites=bn(e.visibleWrites,i.path):ve(i.children,(function(t){e.visibleWrites=bn(e.visibleWrites,et(i.path,t))}));return!0}return!1}function qn(e,t){if(e.snap)return rt(e.path,t);for(var n in e.children)if(e.children.hasOwnProperty(n)&&rt(et(e.path,n),t))return!0;return!1}function An(e){return e.visible}function Ln(e,t,n){for(var i=Tn.empty(),r=0;r<e.length;++r){var o=e[r];if(t(o)){var s=o.path,a=void 0;if(o.snap)rt(n,s)?i=In(i,a=nt(n,s),o.snap):rt(s,n)&&(a=nt(s,n),i=In(i,Ke(),o.snap.getChild(a)));else{if(!o.children)throw I("WriteRecord should have .snap or .children");if(rt(n,s))i=kn(i,a=nt(n,s),o.children);else if(rt(s,n))if(tt(a=nt(s,n)))i=kn(i,Ke(),o.children);else{var u=g(o.children,Ge(a));if(u){var l=u.getChild($e(a));i=In(i,Ke(),l)}}}}}return i}function On(e,t,n,i,r){if(i||r){var o=Pn(e.visibleWrites,t);if(!r&&xn(o))return n;if(r||null!=n||En(o,Ke())){return Rn(Ln(e.allWrites,(function(e){return(e.visible||r)&&(!i||!~i.indexOf(e.writeId))&&(rt(e.path,t)||rt(t,e.path))}),t),n||Lt.EMPTY_NODE)}return null}var s=Sn(e.visibleWrites,t);if(null!=s)return s;var a=Pn(e.visibleWrites,t);return xn(a)?n:null!=n||En(a,Ke())?Rn(a,n||Lt.EMPTY_NODE):null}function Wn(e,t,n,i){return On(e.writeTree,e.treePath,t,n,i)}function Un(e,t){return function(e,t,n){var i=Lt.EMPTY_NODE,r=Sn(e.visibleWrites,t);if(r)return r.isLeafNode()||r.forEachChild(Rt,(function(e,t){i=i.updateImmediateChild(e,t)})),i;if(n){var o=Pn(e.visibleWrites,t);return n.forEachChild(Rt,(function(e,t){var n=Rn(Pn(o,new Be(e)),t);i=i.updateImmediateChild(e,n)})),Nn(o).forEach((function(e){i=i.updateImmediateChild(e.name,e.node)})),i}return Nn(Pn(e.visibleWrites,t)).forEach((function(e){i=i.updateImmediateChild(e.name,e.node)})),i}(e.writeTree,e.treePath,t)}function jn(e,t,n,i){return function(e,t,n,i,r){p(i||r,"Either existingEventSnap or existingServerSnap must exist");var o=et(t,n);if(En(e.visibleWrites,o))return null;var s=Pn(e.visibleWrites,o);return xn(s)?r.getChild(n):Rn(s,r.getChild(n))}(e.writeTree,e.treePath,t,n,i)}function Hn(e,t){return function(e,t){return Sn(e.visibleWrites,t)}(e.writeTree,et(e.treePath,t))}function zn(e,t,n,i,r,o){return function(e,t,n,i,r,o,s){var a,u=Pn(e.visibleWrites,t),l=Sn(u,Ke());if(null!=l)a=l;else{if(null==n)return[];a=Rn(u,n)}if((a=a.withIndex(s)).isEmpty()||a.isLeafNode())return[];for(var h=[],c=s.getCompare(),d=o?a.getReverseIteratorFrom(i,s):a.getIteratorFrom(i,s),f=d.getNext();f&&h.length<r;)0!==c(f,i)&&h.push(f),f=d.getNext();return h}(e.writeTree,e.treePath,t,n,i,r,o)}function Vn(e,t,n){return function(e,t,n,i){var r=et(t,n),o=Sn(e.visibleWrites,r);return null!=o?o:i.isCompleteForChild(n)?Rn(Pn(e.visibleWrites,r),i.getNode().getImmediateChild(n)):null}(e.writeTree,e.treePath,t,n)}function Yn(e,t){return Bn(et(e.treePath,t),e.writeTree)}function Bn(e,t){return{treePath:e,writeTree:t}}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var Kn=function(){function e(){this.changeMap=new Map}var t=e.prototype;return t.trackChildChange=function(e){var t=e.type,n=e.childName;p("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),p(".priority"!==n,"Only non-priority child changes can be tracked.");var i=this.changeMap.get(n);if(i){var r=i.type;if("child_added"===t&&"child_removed"===r)this.changeMap.set(n,Yt(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===r)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===r)this.changeMap.set(n,Vt(n,i.oldSnap));else if("child_changed"===t&&"child_added"===r)this.changeMap.set(n,zt(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==r)throw I("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,Yt(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)},t.getChanges=function(){return Array.from(this.changeMap.values())},e}(),Gn=new(function(){function e(){}var t=e.prototype;return t.getCompleteChild=function(e){return null},t.getChildAfterChild=function(e,t,n){return null},e}()),Qn=function(){function e(e,t,n){void 0===n&&(n=null),this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}var t=e.prototype;return t.getCompleteChild=function(e){var t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);var n=null!=this.optCompleteServerCache_?new fn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Vn(this.writes_,e,n)},t.getChildAfterChild=function(e,t,n){var i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Cn(this.viewCache_),r=zn(this.writes_,i,t,1,n,e);return 0===r.length?null:r[0]},e}();
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */function $n(e,t,n,i,r){var o,s,a=new Kn;if(n.type===rn.OVERWRITE){var u=n;u.source.fromUser?o=Zn(e,t,u.path,u.snap,i,r,a):(p(u.source.fromServer,"Unknown source."),s=u.source.tagged||t.serverCache.isFiltered()&&!tt(u.path),o=Xn(e,t,u.path,u.snap,i,r,s,a))}else if(n.type===rn.MERGE){var l=n;l.source.fromUser?o=function(e,t,n,i,r,o,s){var a=t;return i.foreach((function(i,u){var l=et(n,i);ei(t,Ge(l))&&(a=Zn(e,a,l,u,r,o,s))})),i.foreach((function(i,u){var l=et(n,i);ei(t,Ge(l))||(a=Zn(e,a,l,u,r,o,s))})),a}(e,t,l.path,l.children,i,r,a):(p(l.source.fromServer,"Unknown source."),s=l.source.tagged||t.serverCache.isFiltered(),o=ni(e,t,l.path,l.children,i,r,s,a))}else if(n.type===rn.ACK_USER_WRITE){var h=n;o=h.revert?function(e,t,n,i,r,o){var s;if(null!=Hn(i,n))return t;var a,u=new Qn(i,t,r),l=t.eventCache.getNode();if(tt(n)||".priority"===Ge(n)){var h;if(t.serverCache.isFullyInitialized())h=Wn(i,Cn(t));else{var c=t.serverCache.getNode();p(c instanceof Lt,"serverChildren would be complete if leaf node"),h=Un(i,c)}h=h,a=e.filter.updateFullNode(l,h,o)}else{var d=Ge(n),f=Vn(i,d,t.serverCache);null==f&&t.serverCache.isCompleteForChild(d)&&(f=l.getImmediateChild(d)),(a=null!=f?e.filter.updateChild(l,d,f,$e(n),u,o):t.eventCache.getNode().hasChild(d)?e.filter.updateChild(l,d,Lt.EMPTY_NODE,$e(n),u,o):l).isEmpty()&&t.serverCache.isFullyInitialized()&&(s=Wn(i,Cn(t))).isLeafNode()&&(a=e.filter.updateFullNode(a,s,o))}return s=t.serverCache.isFullyInitialized()||null!=Hn(i,Ke()),gn(t,a,s,e.filter.filtersNodes())}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */(e,t,h.path,i,r,a):function(e,t,n,i,r,o,s){if(null!=Hn(r,n))return t;var a=t.serverCache.isFiltered(),u=t.serverCache;if(null!=i.value){if(tt(n)&&u.isFullyInitialized()||u.isCompleteForPath(n))return Xn(e,t,n,u.getNode().getChild(n),r,o,a,s);if(tt(n)){var l=new wn(null);return u.getNode().forEachChild(_t,(function(e,t){l=l.set(new Be(e),t)})),ni(e,t,n,l,r,o,a,s)}return t}var h=new wn(null);return i.foreach((function(e,t){var i=et(n,e);u.isCompleteForPath(i)&&(h=h.set(e,u.getNode().getChild(i)))})),ni(e,t,n,h,r,o,a,s)}(e,t,h.path,h.affectedTree,i,r,a)}else{if(n.type!==rn.LISTEN_COMPLETE)throw I("Unknown operation type: "+n.type);o=function(e,t,n,i,r){var o=t.serverCache,s=mn(t,o.getNode(),o.isFullyInitialized()||tt(n),o.isFiltered());return Jn(e,s,n,i,Gn,r)}(e,t,n.path,i,a)}var c=a.getChanges();return function(e,t,n){var i=t.eventCache;if(i.isFullyInitialized()){var r=i.getNode().isLeafNode()||i.getNode().isEmpty(),o=yn(e);(n.length>0||!e.eventCache.isFullyInitialized()||r&&!i.getNode().equals(o)||!i.getNode().getPriority().equals(o.getPriority()))&&n.push(Ht(yn(t)))}}(t,o,c),{viewCache:o,changes:c}}function Jn(e,t,n,i,r,o){var s,a,u=t.eventCache;if(null!=Hn(i,n))return t;if(tt(n))if(p(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){var l=Cn(t),h=Un(i,l instanceof Lt?l:Lt.EMPTY_NODE);s=e.filter.updateFullNode(t.eventCache.getNode(),h,o)}else{var c=Wn(i,Cn(t));s=e.filter.updateFullNode(t.eventCache.getNode(),c,o)}else{var d=Ge(n);if(".priority"===d){p(1===Qe(n),"Can't have a priority with additional path components");var f=u.getNode(),_=jn(i,n,f,a=t.serverCache.getNode());s=null!=_?e.filter.updatePriority(f,_):u.getNode()}else{var v,g=$e(n);if(u.isCompleteForChild(d)){a=t.serverCache.getNode();var m=jn(i,n,u.getNode(),a);v=null!=m?u.getNode().getImmediateChild(d).updateChild(g,m):u.getNode().getImmediateChild(d)}else v=Vn(i,d,t.serverCache);s=null!=v?e.filter.updateChild(u.getNode(),d,v,g,r,o):u.getNode()}}return gn(t,s,u.isFullyInitialized()||tt(n),e.filter.filtersNodes())}function Xn(e,t,n,i,r,o,s,a){var u,l=t.serverCache,h=s?e.filter:e.filter.getIndexedFilter();if(tt(n))u=h.updateFullNode(l.getNode(),i,null);else if(h.filtersNodes()&&!l.isFiltered()){var c=l.getNode().updateChild(n,i);u=h.updateFullNode(l.getNode(),c,null)}else{var d=Ge(n);if(!l.isCompleteForPath(n)&&Qe(n)>1)return t;var f=$e(n),p=l.getNode().getImmediateChild(d).updateChild(f,i);u=".priority"===d?h.updatePriority(l.getNode(),p):h.updateChild(l.getNode(),d,p,f,Gn,null)}var _=mn(t,u,l.isFullyInitialized()||tt(n),h.filtersNodes());return Jn(e,_,n,r,new Qn(r,_,o),a)}function Zn(e,t,n,i,r,o,s){var a,u,l=t.eventCache,h=new Qn(r,t,o);if(tt(n))u=e.filter.updateFullNode(t.eventCache.getNode(),i,s),a=gn(t,u,!0,e.filter.filtersNodes());else{var c=Ge(n);if(".priority"===c)u=e.filter.updatePriority(t.eventCache.getNode(),i),a=gn(t,u,l.isFullyInitialized(),l.isFiltered());else{var d,f=$e(n),p=l.getNode().getImmediateChild(c);if(tt(f))d=i;else{var _=h.getCompleteChild(c);d=null!=_?".priority"===Je(f)&&_.getChild(Ze(f)).isEmpty()?_:_.updateChild(f,i):Lt.EMPTY_NODE}if(p.equals(d))a=t;else a=gn(t,e.filter.updateChild(l.getNode(),c,d,f,h,s),l.isFullyInitialized(),e.filter.filtersNodes())}}return a}function ei(e,t){return e.eventCache.isCompleteForChild(t)}function ti(e,t,n){return n.foreach((function(e,n){t=t.updateChild(e,n)})),t}function ni(e,t,n,i,r,o,s,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;var u,l=t;u=tt(n)?i:new wn(null).setTree(n,i);var h=t.serverCache.getNode();return u.children.inorderTraversal((function(n,i){if(h.hasChild(n)){var u=ti(0,t.serverCache.getNode().getImmediateChild(n),i);l=Xn(e,l,new Be(n),u,r,o,s,a)}})),u.children.inorderTraversal((function(n,i){var u=!t.serverCache.isCompleteForChild(n)&&null===i.value;if(!h.hasChild(n)&&!u){var c=ti(0,t.serverCache.getNode().getImmediateChild(n),i);l=Xn(e,l,new Be(n),c,r,o,s,a)}})),l}var ii,ri=function(){function e(e,t){this.query_=e,this.eventRegistrations_=[];var n,i=this.query_._queryParams,r=new Bt(i.getIndex()),o=(n=i).loadsAllData()?new Bt(n.getIndex()):n.hasLimit()?new Gt(n):new Kt(n);this.processor_=
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * limitations under the License.
      */
function(e){return{filter:e}}(o);var s=t.serverCache,a=t.eventCache,u=r.updateFullNode(Lt.EMPTY_NODE,s.getNode(),null),l=o.updateFullNode(Lt.EMPTY_NODE,a.getNode(),null),h=new fn(u,s.isFullyInitialized(),r.filtersNodes()),c=new fn(l,a.isFullyInitialized(),o.filtersNodes());this.viewCache_=vn(c,h),this.eventGenerator_=new pn(this.query_)}return i(e,[{key:"query",get:function(){return this.query_}}]),e}();function oi(e,t){var n=Cn(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!tt(t)&&!n.getImmediateChild(Ge(t)).isEmpty())?n.getChild(t):null}function si(e){return 0===e.eventRegistrations_.length}function ai(e,t,n){var i=[];if(n){p(null==t,"A cancel should cancel all event registrations.");var r=e.query._path;e.eventRegistrations_.forEach((function(e){var t=e.createCancelEvent(n,r);t&&i.push(t)}))}if(t){for(var o=[],s=0;s<e.eventRegistrations_.length;++s){var a=e.eventRegistrations_[s];if(a.matches(t)){if(t.hasAnyCallback()){o=o.concat(e.eventRegistrations_.slice(s+1));break}}else o.push(a)}e.eventRegistrations_=o}else e.eventRegistrations_=[];return i}function ui(e,t,n,i){t.type===rn.MERGE&&null!==t.source.queryId&&(p(Cn(e.viewCache_),"We should always have a full cache before handling merges"),p(yn(e.viewCache_),"Missing event cache, even though we have a server cache"));var r,o,s=e.viewCache_,a=$n(e.processor_,s,t,n,i);return r=e.processor_,o=a.viewCache,p(o.eventCache.getNode().isIndexed(r.filter.getIndex()),"Event snap not indexed"),p(o.serverCache.getNode().isIndexed(r.filter.getIndex()),"Server snap not indexed"),p(a.viewCache.serverCache.isFullyInitialized()||!s.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=a.viewCache,li(e,a.changes,a.viewCache.eventCache.getNode(),null)}function li(e,t,n,i){var r=i?[i]:e.eventRegistrations_;return function(e,t,n,i){var r=[],o=[];return t.forEach((function(t){var n;"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&o.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),_n(e,r,"child_removed",t,i,n),_n(e,r,"child_added",t,i,n),_n(e,r,"child_moved",o,i,n),_n(e,r,"child_changed",t,i,n),_n(e,r,"value",t,i,n),r}(e.eventGenerator_,t,n,r)}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var hi,ci=function(){this.views=new Map};function di(e,t,i,r){var o=t.source.queryId;if(null!==o){var s=e.views.get(o);return p(null!=s,"SyncTree gave us an op for an invalid query."),ui(s,t,i,r)}for(var a,u=[],l=n(e.views.values());!(a=l()).done;){var h=a.value;u=u.concat(ui(h,t,i,r))}return u}function fi(e,t,n,i,r){var o=t._queryIdentifier,s=e.views.get(o);if(!s){var a=Wn(n,r?i:null),u=!1;a?u=!0:i instanceof Lt?(a=Un(n,i),u=!1):(a=Lt.EMPTY_NODE,u=!1);var l=vn(new fn(a,u,!1),new fn(i,r,!1));return new ri(t,l)}return s}function pi(e,t,n,i,r,o){var s=fi(e,t,i,r,o);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,s),function(e,t){e.eventRegistrations_.push(t)}(s,n),function(e,t){var n=e.viewCache_.eventCache,i=[];return n.getNode().isLeafNode()||n.getNode().forEachChild(Rt,(function(e,t){i.push(zt(e,t))})),n.isFullyInitialized()&&i.push(Ht(n.getNode())),li(e,i,n.getNode(),t)}(s,n)}function _i(e,t,i,r){var o=t._queryIdentifier,s=[],a=[],u=Ci(e);if("default"===o)for(var l,h=n(e.views.entries());!(l=h()).done;){var c=l.value,d=c[0],f=c[1];a=a.concat(ai(f,i,r)),si(f)&&(e.views.delete(d),f.query._queryParams.loadsAllData()||s.push(f.query))}else{var _=e.views.get(o);_&&(a=a.concat(ai(_,i,r)),si(_)&&(e.views.delete(o),_.query._queryParams.loadsAllData()||s.push(_.query)))}return u&&!Ci(e)&&s.push(new(p(ii,"Reference.ts has not been loaded"),ii)(t._repo,t._path)),{removed:s,events:a}}function vi(e){for(var t,i=[],r=n(e.views.values());!(t=r()).done;){var o=t.value;o.query._queryParams.loadsAllData()||i.push(o)}return i}function gi(e,t){for(var i,r=null,o=n(e.views.values());!(i=o()).done;){var s=i.value;r=r||oi(s,t)}return r}function mi(e,t){if(t._queryParams.loadsAllData())return wi(e);var n=t._queryIdentifier;return e.views.get(n)}function yi(e,t){return null!=mi(e,t)}function Ci(e){return null!=wi(e)}function wi(e){for(var t,i=n(e.views.values());!(t=i()).done;){var r=t.value;if(r.query._queryParams.loadsAllData())return r}return null}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var Ti=1,Ii=function(e){this.listenProvider_=e,this.syncPointTree_=new wn(null),this.pendingWriteTree_={visibleWrites:Tn.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map};function ki(e,t,n,i,r){return function(e,t,n,i,r){p(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=In(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?Ri(e,new cn({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function bi(e,t,n){void 0===n&&(n=!1);var i=function(e,t){for(var n=0;n<e.allWrites.length;n++){var i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(Fn(e.pendingWriteTree_,t)){var r=new wn(null);return null!=i.snap?r=r.set(Ke(),!0):ve(i.children,(function(e){r=r.set(new Be(e),!0)})),Ri(e,new ln(i.path,r,n))}return[]}function Ei(e,t,n){return Ri(e,new cn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Si(e,t,n,i,r){void 0===r&&(r=!1);var o=t._path,s=e.syncPointTree_.get(o),a=[];if(s&&("default"===t._queryIdentifier||yi(s,t))){var u=_i(s,t,n,i);0===s.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(o));var l=u.removed;if(a=u.events,!r){var h=-1!==l.findIndex((function(e){return e._queryParams.loadsAllData()})),c=e.syncPointTree_.findOnPath(o,(function(e,t){return Ci(t)}));if(h&&!c){var d=e.syncPointTree_.subtree(o);if(!d.isEmpty())for(var f=function(e){return e.fold((function(e,t,n){if(t&&Ci(t))return[wi(t)];var i=[];return t&&(i=vi(t)),ve(n,(function(e,t){i=i.concat(t)})),i}))}(d),p=0;p<f.length;++p){var _=f[p],v=_.query,g=Fi(e,_);e.listenProvider_.startListening(Ui(v),qi(e,v),g.hashFn,g.onComplete)}}if(!c&&l.length>0&&!i)if(h){e.listenProvider_.stopListening(Ui(t),null)}else l.forEach((function(t){var n=e.queryToTagMap.get(Ai(t));e.listenProvider_.stopListening(Ui(t),n)}))}!function(e,t){for(var n=0;n<t.length;++n){var i=t[n];if(!i._queryParams.loadsAllData()){var r=Ai(i),o=e.queryToTagMap.get(r);e.queryToTagMap.delete(r),e.tagToQueryMap.delete(o)}}}(e,l)}return a}function Ni(e,t,n,i){var r=Li(e,i);if(null!=r){var o=Oi(r),s=o.path,a=o.queryId,u=nt(s,t);return Wi(e,s,new cn(an(a),u,n))}return[]}function Pi(e,t,n,i){void 0===i&&(i=!1);var r=t._path,o=null,s=!1;e.syncPointTree_.foreachOnPath(r,(function(e,t){var n=nt(e,r);o=o||gi(t,n),s=s||Ci(t)}));var a,u=e.syncPointTree_.get(r);(u?(s=s||Ci(u),o=o||gi(u,Ke())):(u=new ci,e.syncPointTree_=e.syncPointTree_.set(r,u)),null!=o)?a=!0:(a=!1,o=Lt.EMPTY_NODE,e.syncPointTree_.subtree(r).foreachChild((function(e,t){var n=gi(t,Ke());n&&(o=o.updateImmediateChild(e,n))})));var l=yi(u,t);if(!l&&!t._queryParams.loadsAllData()){var h=Ai(t);p(!e.queryToTagMap.has(h),"View does not exist, but we have a tag");var c=Ti++;e.queryToTagMap.set(h,c),e.tagToQueryMap.set(c,h)}var d=pi(u,t,n,Mn(e.pendingWriteTree_,r),o,a);if(!l&&!s&&!i){var f=mi(u,t);d=d.concat(function(e,t,n){var i=t._path,r=qi(e,t),o=Fi(e,n),s=e.listenProvider_.startListening(Ui(t),r,o.hashFn,o.onComplete),a=e.syncPointTree_.subtree(i);if(r)p(!Ci(a.value),"If we're adding a query, it shouldn't be shadowed");else for(var u=a.fold((function(e,t,n){if(!tt(e)&&t&&Ci(t))return[wi(t).query];var i=[];return t&&(i=i.concat(vi(t).map((function(e){return e.query})))),ve(n,(function(e,t){i=i.concat(t)})),i})),l=0;l<u.length;++l){var h=u[l];e.listenProvider_.stopListening(Ui(h),qi(e,h))}return s}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */(e,t,f))}return d}function xi(e,t,n){var i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,(function(e,n){var i=gi(n,nt(e,t));if(i)return i}));return On(i,t,r,n,!0)}function Ri(e,t){return Di(t,e.syncPointTree_,null,Mn(e.pendingWriteTree_,Ke()))}function Di(e,t,n,i){if(tt(e.path))return Mi(e,t,n,i);var r=t.get(Ke());null==n&&null!=r&&(n=gi(r,Ke()));var o=[],s=Ge(e.path),a=e.operationForChild(s),u=t.children.get(s);if(u&&a){var l=n?n.getImmediateChild(s):null,h=Yn(i,s);o=o.concat(Di(a,u,l,h))}return r&&(o=o.concat(di(r,e,i,n))),o}function Mi(e,t,n,i){var r=t.get(Ke());null==n&&null!=r&&(n=gi(r,Ke()));var o=[];return t.children.inorderTraversal((function(t,r){var s=n?n.getImmediateChild(t):null,a=Yn(i,t),u=e.operationForChild(t);u&&(o=o.concat(Mi(u,r,s,a)))})),r&&(o=o.concat(di(r,e,i,n))),o}function Fi(e,t){var n=t.query,i=qi(e,n);return{hashFn:function(){return(function(e){return e.viewCache_.serverCache.getNode()}(t)||Lt.EMPTY_NODE).hash()},onComplete:function(t){if("ok"===t)return i?function(e,t,n){var i=Li(e,n);if(i){var r=Oi(i),o=r.path,s=r.queryId,a=nt(o,t);return Wi(e,o,new hn(an(s),a))}return[]}(e,n._path,i):function(e,t){return Ri(e,new hn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);var r=function(e,t){var n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");var i=new Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return Si(e,n,null,r)}}}function qi(e,t){var n=Ai(t);return e.queryToTagMap.get(n)}function Ai(e){return e._path.toString()+"$"+e._queryIdentifier}function Li(e,t){return e.tagToQueryMap.get(t)}function Oi(e){var t=e.indexOf("$");return p(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Be(e.substr(0,t))}}function Wi(e,t,n){var i=e.syncPointTree_.get(t);return p(i,"Missing sync point for query tag that we're tracking"),di(i,n,Mn(e.pendingWriteTree_,t),null)}function Ui(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(p(hi,"Reference.ts has not been loaded"),hi)(e._repo,e._path):e}var ji=function(){function e(e){this.node_=e}var t=e.prototype;return t.getImmediateChild=function(t){return new e(this.node_.getImmediateChild(t))},t.node=function(){return this.node_},e}(),Hi=function(){function e(e,t){this.syncTree_=e,this.path_=t}var t=e.prototype;return t.getImmediateChild=function(t){var n=et(this.path_,t);return new e(this.syncTree_,n)},t.node=function(){return xi(this.syncTree_,this.path_)},e}(),zi=function(e,t,n){return e&&"object"==typeof e?(p(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Vi(e[".sv"],t,n):"object"==typeof e[".sv"]?Yi(e[".sv"],t):void p(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Vi=function(e,t,n){switch(e){case"timestamp":return n.timestamp;default:p(!1,"Unexpected server value: "+e)}},Yi=function(e,t,n){e.hasOwnProperty("increment")||p(!1,"Unexpected server value: "+JSON.stringify(e,null,2));var i=e.increment;"number"!=typeof i&&p(!1,"Unexpected increment value: "+i);var r=t.node();if(p(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return i;var o=r.getValue();return"number"!=typeof o?i:o+i},Bi=function(e,t,n){return Ki(e,new ji(t),n)};function Ki(e,t,n){var i,r=e.getPriority().val(),o=zi(r,t.getImmediateChild(".priority"),n);if(e.isLeafNode()){var s=e,a=zi(s.getValue(),t,n);return a!==s.getValue()||o!==s.getPriority().val()?new Nt(a,Wt(o)):e}var u=e;return i=u,o!==u.getPriority().val()&&(i=i.updatePriority(new Nt(o))),u.forEachChild(Rt,(function(e,r){var o=Ki(r,t.getImmediateChild(e),n);o!==r&&(i=i.updateImmediateChild(e,o))})),i}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var Gi=function(e,t,n){void 0===e&&(e=""),void 0===t&&(t=null),void 0===n&&(n={children:{},childCount:0}),this.name=e,this.parent=t,this.node=n};function Qi(e,t){for(var n=t instanceof Be?t:new Be(t),i=e,r=Ge(n);null!==r;){var o=g(i.node.children,r)||{children:{},childCount:0};i=new Gi(r,i,o),r=Ge(n=$e(n))}return i}function $i(e){return e.node.value}function Ji(e,t){e.node.value=t,nr(e)}function Xi(e){return e.node.childCount>0}function Zi(e,t){ve(e.node.children,(function(n,i){t(new Gi(n,e,i))}))}function er(e,t,n,i){n&&!i&&t(e),Zi(e,(function(e){er(e,t,!0,i)})),n&&i&&t(e)}function tr(e){return new Be(null===e.parent?e.name:tr(e.parent)+"/"+e.name)}function nr(e){null!==e.parent&&function(e,t,n){var i=function(e){return void 0===$i(e)&&!Xi(e)}(n),r=v(e.node.children,t);i&&r?(delete e.node.children[t],e.node.childCount--,nr(e)):i||r||(e.node.children[t]=n.node,e.node.childCount++,nr(e))}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */(e.parent,e.name,e)}var ir=/[\[\].#$\/\u0000-\u001F\u007F]/,rr=/[\[\].#$\u0000-\u001F\u007F]/,or=10485760,sr=function(e){return"string"==typeof e&&0!==e.length&&!ir.test(e)},ar=function(e){return"string"==typeof e&&0!==e.length&&!rr.test(e)},ur=function(e,t,n,i){i&&void 0===t||lr(M(e,"value"),t,n)},lr=function e(t,n,i){var r=i instanceof Be?new ot(i,t):i;if(void 0===n)throw new Error(t+"contains undefined "+at(r));if("function"==typeof n)throw new Error(t+"contains a function "+at(r)+" with contents = "+n.toString());if(ue(n))throw new Error(t+"contains "+n.toString()+" "+at(r));if("string"==typeof n&&n.length>or/3&&D(n)>or)throw new Error(t+"contains a string greater than "+"10485760 utf8 bytes "+at(r)+" ('"+n.substring(0,50)+"...')");if(n&&"object"==typeof n){var o=!1,s=!1;if(ve(n,(function(n,i){if(".value"===n)o=!0;else if(".priority"!==n&&".sv"!==n&&(s=!0,!sr(n)))throw new Error(t+" contains an invalid key ("+n+") "+at(r)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var a,u;u=n,(a=r).parts_.length>0&&(a.byteLength_+=1),a.parts_.push(u),a.byteLength_+=D(u),st(a),e(t,i,r),function(e){var t=e.parts_.pop();e.byteLength_-=D(t),e.parts_.length>0&&(e.byteLength_-=1)}(r)})),o&&s)throw new Error(t+' contains ".value" child '+at(r)+" in addition to actual children.")}},hr=e("_validatePathString",(function(e,t,n,i){if(!(i&&void 0===n||ar(n)))throw new Error(M(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')})),cr=e("_validateWritablePath",(function(e,t){if(".info"===Ge(t))throw new Error(e+" failed = Can't modify data under /.info/")})),dr=function(e,t){var n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!sr(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),ar(e)}(n))throw new Error(M(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')},fr=function(){this.eventLists_=[],this.recursionDepth_=0};function pr(e,t){for(var n=null,i=0;i<t.length;i++){var r=t[i],o=r.getPath();null===n||it(o,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:o}),n.events.push(r)}n&&e.eventLists_.push(n)}function _r(e,t,n){pr(e,n),gr(e,(function(e){return it(e,t)}))}function vr(e,t,n){pr(e,n),gr(e,(function(e){return rt(e,t)||rt(t,e)}))}function gr(e,t){e.recursionDepth_++;for(var n=!0,i=0;i<e.eventLists_.length;i++){var r=e.eventLists_[i];if(r)t(r.path)?(mr(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}n&&(e.eventLists_=[]),e.recursionDepth_--}function mr(e){for(var t=0;t<e.events.length;t++){var n=e.events[t];if(null!==n){e.events[t]=null;var i=n.getEventRunner();ee&&ie("event: "+n.toString()),Ce(i)}}}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var yr=function(){function e(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new fr,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=en(),this.transactionQueueTree_=new Gi,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}return e.prototype.toString=function(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host},e}();function Cr(e,t,n){if(e.stats_=Me(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new Xt(e.repoInfo_,(function(t,n,i,r){Ir(e,t,n,i,r)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((function(){return kr(e,!0)}),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{f(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new ht(e.repoInfo_,t,(function(t,n,i,r){Ir(e,t,n,i,r)}),(function(t){kr(e,t)}),(function(t){!function(e,t){ve(t,(function(t,n){br(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}var i,r,o;e.authTokenProvider_.addTokenChangeListener((function(t){e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((function(t){e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=(i=e.repoInfo_,r=function(){return new sn(e.stats_,e.server_)},o=i.toString(),De[o]||(De[o]=r()),De[o]),e.infoData_=new Zt,e.infoSyncTree_=new Ii({startListening:function(t,n,i,r){var o=[],s=e.infoData_.getNode(t._path);return s.isEmpty()||(o=Ei(e.infoSyncTree_,t._path,s),setTimeout((function(){r("ok")}),0)),o},stopListening:function(){}}),br(e,"connected",!1),e.serverSyncTree_=new Ii({startListening:function(t,n,i,r){return e.server_.listen(t,i,n,(function(n,i){var o=r(n,i);vr(e.eventQueue_,t._path,o)})),[]},stopListening:function(t,n){e.server_.unlisten(t,n)}})}function wr(e){var t=e.infoData_.getNode(new Be(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function Tr(e){return(t=(t={timestamp:wr(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function Ir(e,t,n,i,r){e.dataUpdateCount++;var o=new Be(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;var s=[];if(r)if(i){var a=R(n,(function(e){return Wt(e)}));s=function(e,t,n,i){var r=Li(e,i);if(r){var o=Oi(r),s=o.path,a=o.queryId,u=nt(s,t),l=wn.fromObject(n);return Wi(e,s,new dn(an(a),u,l))}return[]}(e.serverSyncTree_,o,a,r)}else{var u=Wt(n);s=Ni(e.serverSyncTree_,o,u,r)}else if(i){var l=R(n,(function(e){return Wt(e)}));s=function(e,t,n){var i=wn.fromObject(n);return Ri(e,new dn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,o,l)}else{var h=Wt(n);s=Ei(e.serverSyncTree_,o,h)}var c=o;s.length>0&&(c=Dr(e,o)),vr(e.eventQueue_,c,s)}function kr(e,t){br(e,"connected",t),!1===t&&function(e){Pr(e,"onDisconnectEvents");var t=Tr(e),n=en();nn(e.onDisconnect_,Ke(),(function(i,r){var o=function(e,t,n,i){return Ki(t,new Hi(n,e),i)}(i,r,e.serverSyncTree_,t);tn(n,i,o)}));var i=[];nn(n,Ke(),(function(t,n){i=i.concat(Ei(e.serverSyncTree_,t,n));var r=Lr(e,t);Dr(e,r)})),e.onDisconnect_=en(),vr(e.eventQueue_,Ke(),i)}(e)}function br(e,t,n){var i=new Be("/.info/"+t),r=Wt(n);e.infoData_.updateSnapshot(i,r);var o=Ei(e.infoSyncTree_,i,r);vr(e.eventQueue_,i,o)}function Er(e){return e.nextWriteId_++}function Sr(e,t,n,i,r){Pr(e,"set",{path:t.toString(),value:n,priority:i});var o=Tr(e),s=Wt(n,i),a=xi(e.serverSyncTree_,t),u=Bi(s,a,o),l=Er(e),h=ki(e.serverSyncTree_,t,u,l,!0);pr(e.eventQueue_,h),e.server_.put(t.toString(),s.val(!0),(function(n,i){var o="ok"===n;o||ae("set at "+t+" failed: "+n);var s=bi(e.serverSyncTree_,l,!o);vr(e.eventQueue_,t,s),function(e,t,n,i){t&&Ce((function(){if("ok"===n)t(null);else{var e=(n||"error").toUpperCase(),r=e;i&&(r+=": "+i);var o=new Error(r);o.code=e,t(o)}}))}(0,r,n,i)}));var c=Lr(e,t);Dr(e,c),vr(e.eventQueue_,c,[])}function Nr(e,t,n){var i;i=".info"===Ge(t._path)?Si(e.infoSyncTree_,t,n):Si(e.serverSyncTree_,t,n),_r(e.eventQueue_,t._path,i)}function Pr(e){var t="";e.persistentConnection_&&(t=e.persistentConnection_.id+":");for(var n=arguments.length,i=new Array(n>1?n-1:0),r=1;r<n;r++)i[r-1]=arguments[r];ie.apply(void 0,[t].concat(i))}function xr(e,t,n){return xi(e.serverSyncTree_,t,n)||Lt.EMPTY_NODE}function Rr(e,t){if(void 0===t&&(t=e.transactionQueueTree_),t||Ar(e,t),$i(t)){var n=Fr(e,t);p(n.length>0,"Sending zero length transaction queue"),n.every((function(e){return 0===e.status}))&&function(e,t,n){for(var i=n.map((function(e){return e.currentWriteId})),r=xr(e,t,i),o=r,s=r.hash(),a=0;a<n.length;a++){var u=n[a];p(0===u.status,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;var l=nt(t,u.path);o=o.updateChild(l,u.currentOutputSnapshotRaw)}var h=o.val(!0),c=t;e.server_.put(c.toString(),h,(function(i){Pr(e,"transaction put response",{path:c.toString(),status:i});var r=[];if("ok"===i){for(var o=[],s=function(t){n[t].status=2,r=r.concat(bi(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&o.push((function(){return n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved)})),n[t].unwatcher()},a=0;a<n.length;a++)s(a);Ar(e,Qi(e.transactionQueueTree_,t)),Rr(e,e.transactionQueueTree_),vr(e.eventQueue_,t,r);for(var u=0;u<o.length;u++)Ce(o[u])}else{if("datastale"===i)for(var l=0;l<n.length;l++)3===n[l].status?n[l].status=4:n[l].status=0;else{ae("transaction at "+c.toString()+" failed: "+i);for(var h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=i}Dr(e,t)}}),s)}(e,tr(t),n)}else Xi(t)&&Zi(t,(function(t){Rr(e,t)}))}function Dr(e,t){var n=Mr(e,t),i=tr(n);return function(e,t,n){if(0===t.length)return;for(var i=[],r=[],o=t.filter((function(e){return 0===e.status})).map((function(e){return e.currentWriteId})),s=function(s){var a,u,l=t[s],h=nt(n,l.path),c=!1;if(p(null!==h,"rerunTransactionsUnderNode_: relativePath should not be null."),4===l.status)c=!0,a=l.abortReason,r=r.concat(bi(e.serverSyncTree_,l.currentWriteId,!0));else if(0===l.status)if(l.retryCount>=25)c=!0,a="maxretry",r=r.concat(bi(e.serverSyncTree_,l.currentWriteId,!0));else{var d=xr(e,l.path,o);l.currentInputSnapshot=d;var f=t[s].update(d.val());if(void 0!==f){lr("transaction failed: Data returned ",f,l.path);var _=Wt(f);"object"==typeof f&&null!=f&&v(f,".priority")||(_=_.updatePriority(d.getPriority()));var g=l.currentWriteId,m=Tr(e),y=Bi(_,d,m);l.currentOutputSnapshotRaw=_,l.currentOutputSnapshotResolved=y,l.currentWriteId=Er(e),o.splice(o.indexOf(g),1),r=(r=r.concat(ki(e.serverSyncTree_,l.path,y,l.currentWriteId,l.applyLocally))).concat(bi(e.serverSyncTree_,g,!0))}else c=!0,a="nodata",r=r.concat(bi(e.serverSyncTree_,l.currentWriteId,!0))}vr(e.eventQueue_,n,r),r=[],c&&(t[s].status=2,u=t[s].unwatcher,setTimeout(u,Math.floor(0)),t[s].onComplete&&("nodata"===a?i.push((function(){return t[s].onComplete(null,!1,t[s].currentInputSnapshot)})):i.push((function(){return t[s].onComplete(new Error(a),!1,null)}))))},a=0;a<t.length;a++)s(a);Ar(e,e.transactionQueueTree_);for(var u=0;u<i.length;u++)Ce(i[u]);Rr(e,e.transactionQueueTree_)}(e,Fr(e,n),i),i}function Mr(e,t){var n,i=e.transactionQueueTree_;for(n=Ge(t);null!==n&&void 0===$i(i);)i=Qi(i,n),n=Ge(t=$e(t));return i}function Fr(e,t){var n=[];return qr(e,t,n),n.sort((function(e,t){return e.order-t.order})),n}function qr(e,t,n){var i=$i(t);if(i)for(var r=0;r<i.length;r++)n.push(i[r]);Zi(t,(function(t){qr(e,t,n)}))}function Ar(e,t){var n=$i(t);if(n){for(var i=0,r=0;r<n.length;r++)2!==n[r].status&&(n[i]=n[r],i++);n.length=i,Ji(t,n.length>0?n:void 0)}Zi(t,(function(t){Ar(e,t)}))}function Lr(e,t){var n=tr(Mr(e,t)),i=Qi(e.transactionQueueTree_,t);return function(e,t,n){for(var i=n?e:e.parent;null!==i;){if(t(i))return!0;i=i.parent}}(i,(function(t){Or(e,t)})),Or(e,i),er(i,(function(t){Or(e,t)})),n}function Or(e,t){var n=$i(t);if(n){for(var i=[],r=[],o=-1,s=0;s<n.length;s++)3===n[s].status||(1===n[s].status?(p(o===s-1,"All SENT items should be at beginning of queue."),o=s,n[s].status=3,n[s].abortReason="set"):(p(0===n[s].status,"Unexpected transaction status in abort"),n[s].unwatcher(),r=r.concat(bi(e.serverSyncTree_,n[s].currentWriteId,!0)),n[s].onComplete&&i.push(n[s].onComplete.bind(null,new Error("set"),!1,null))));-1===o?Ji(t,void 0):n.length=o+1,vr(e.eventQueue_,tr(t),r);for(var a=0;a<i.length;a++)Ce(i[a])}}
/**
      * @license
      * Copyright 2017 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */var Wr,Ur,jr=function(e,t){var n=Hr(e),i=n.namespace;"firebase.com"===n.domain&&se(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),i&&"undefined"!==i||"localhost"===n.domain||se("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||"undefined"!=typeof window&&window.location&&window.location.protocol&&-1!==window.location.protocol.indexOf("https:")&&ae("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().");var r="ws"===n.scheme||"wss"===n.scheme;return{repoInfo:new Ne(n.host,n.secure,i,r,t,"",i!==n.subdomain),path:new Be(n.pathString)}},Hr=function(e){var t="",i="",r="",o="",s="",a=!0,u="https",l=443;if("string"==typeof e){var h=e.indexOf("//");h>=0&&(u=e.substring(0,h-1),e=e.substring(h+2));var c=e.indexOf("/");-1===c&&(c=e.length);var d=e.indexOf("?");-1===d&&(d=e.length),t=e.substring(0,Math.min(c,d)),c<d&&(o=function(e){for(var t="",n=e.split("/"),i=0;i<n.length;i++)if(n[i].length>0){var r=n[i];try{r=decodeURIComponent(r.replace(/\+/g," "))}catch(e){}t+="/"+r}return t}(e.substring(c,d)));var f=function(e){var t={};"?"===e.charAt(0)&&(e=e.substring(1));for(var i,r=n(e.split("&"));!(i=r()).done;){var o=i.value;if(0!==o.length){var s=o.split("=");2===s.length?t[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):ae("Invalid query segment '"+o+"' in query '"+e+"'")}}return t}(e.substring(Math.min(e.length,d)));(h=t.indexOf(":"))>=0?(a="https"===u||"wss"===u,l=parseInt(t.substring(h+1),10)):h=t.length;var p=t.slice(0,h);if("localhost"===p.toLowerCase())i="localhost";else if(p.split(".").length<=2)i=p;else{var _=t.indexOf(".");r=t.substring(0,_).toLowerCase(),i=t.substring(_+1),s=r}"ns"in f&&(s=f.ns)}return{host:t,port:l,domain:i,subdomain:r,secure:a,scheme:u,pathString:o,namespace:s}},zr="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",Vr=(Wr=0,Ur=[],function(e){var t,n=e===Wr;Wr=e;var i=new Array(8);for(t=7;t>=0;t--)i[t]=zr.charAt(e%64),e=Math.floor(e/64);p(0===e,"Cannot push at time == 0");var r=i.join("");if(n){for(t=11;t>=0&&63===Ur[t];t--)Ur[t]=0;Ur[t]++}else for(t=0;t<12;t++)Ur[t]=Math.floor(64*Math.random());for(t=0;t<12;t++)r+=zr.charAt(Ur[t]);return p(20===r.length,"nextPushId: Length should be 20."),r}),Yr=function(){function e(e,t,n,i){this.eventType=e,this.eventRegistration=t,this.snapshot=n,this.prevName=i}var t=e.prototype;return t.getPath=function(){var e=this.snapshot.ref;return"value"===this.eventType?e._path:e.parent._path},t.getEventType=function(){return this.eventType},t.getEventRunner=function(){return this.eventRegistration.getEventRunner(this)},t.toString=function(){return this.getPath().toString()+":"+this.eventType+":"+f(this.snapshot.exportVal())},e}(),Br=function(){function e(e,t,n){this.eventRegistration=e,this.error=t,this.path=n}var t=e.prototype;return t.getPath=function(){return this.path},t.getEventType=function(){return"cancel"},t.getEventRunner=function(){return this.eventRegistration.getEventRunner(this)},t.toString=function(){return this.path.toString()+":cancel"},e}(),Kr=function(){function e(e,t){this.snapshotCallback=e,this.cancelCallback=t}var t=e.prototype;return t.onValue=function(e,t){this.snapshotCallback.call(null,e,t)},t.onCancel=function(e){return p(this.hasCancelCallback,"Raising a cancel event on a listener with no cancel callback"),this.cancelCallback.call(null,e)},t.matches=function(e){return this.snapshotCallback===e.snapshotCallback||void 0!==this.snapshotCallback.userCallback&&this.snapshotCallback.userCallback===e.snapshotCallback.userCallback&&this.snapshotCallback.context===e.snapshotCallback.context},i(e,[{key:"hasCancelCallback",get:function(){return!!this.cancelCallback}}]),e}(),Gr=e("_QueryImpl",function(){function e(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}var t=e.prototype;return t.isEqual=function(t){if(!((t=b(t))instanceof e))return!1;var n=this._repo===t._repo,i=it(this._path,t._path),r=this._queryIdentifier===t._queryIdentifier;return n&&i&&r},t.toJSON=function(){return this.toString()},t.toString=function(){return this._repo.toString()+function(e){for(var t="",n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)},i(e,[{key:"key",get:function(){return tt(this._path)?null:Je(this._path)}},{key:"ref",get:function(){return new Qr(this._repo,this._path)}},{key:"_queryIdentifier",get:function(){var e=Jt(this._queryParams),t=pe(e);return"{}"===t?"default":t}},{key:"_queryObject",get:function(){return Jt(this._queryParams)}}]),e}()),Qr=e("_ReferenceImpl",function(e){function n(t,n){return e.call(this,t,n,new Qt,!1)||this}return t(n,e),i(n,[{key:"parent",get:function(){var e=Ze(this._path);return null===e?null:new n(this._repo,e)}},{key:"root",get:function(){for(var e=this;null!==e.parent;)e=e.parent;return e}}]),n}(Gr)),$r=e("DataSnapshot",function(){function e(e,t,n){this._node=e,this.ref=t,this._index=n}var t=e.prototype;return t.child=function(t){var n=new Be(t),i=Jr(this.ref,t);return new e(this._node.getChild(n),i,Rt)},t.exists=function(){return!this._node.isEmpty()},t.exportVal=function(){return this._node.val(!0)},t.forEach=function(t){var n=this;return!this._node.isLeafNode()&&!!this._node.forEachChild(this._index,(function(i,r){return t(new e(r,Jr(n.ref,i),Rt))}))},t.hasChild=function(e){var t=new Be(e);return!this._node.getChild(t).isEmpty()},t.hasChildren=function(){return!this._node.isLeafNode()&&!this._node.isEmpty()},t.toJSON=function(){return this.exportVal()},t.val=function(){return this._node.val()},i(e,[{key:"priority",get:function(){return this._node.getPriority().val()}},{key:"key",get:function(){return this.ref.key}},{key:"size",get:function(){return this._node.numChildren()}}]),e}());function Jr(e,t){var n,i,r,o;return null===Ge((e=b(e))._path)?(n="child",i="path",o=!1,(r=t)&&(r=r.replace(/^\/*\.info(\/|$)/,"/")),hr(n,i,r,o)):hr("child","path",t,!1),new Qr(e._repo,et(e._path,t))}function Xr(e,t){e=b(e),cr("set",e._path),ur("set",t,e._path,!1);var n=new _;return Sr(e._repo,e._path,t,null,n.wrapCallback((function(){}))),n.promise}var Zr=function(){function e(e){this.callbackContext=e}var t=e.prototype;return t.respondsTo=function(e){return"value"===e},t.createEvent=function(e,t){var n=t._queryParams.getIndex();return new Yr("value",this,new $r(e.snapshotNode,new Qr(t._repo,t._path),n))},t.getEventRunner=function(e){var t=this;return"cancel"===e.getEventType()?function(){return t.callbackContext.onCancel(e.error)}:function(){return t.callbackContext.onValue(e.snapshot,null)}},t.createCancelEvent=function(e,t){return this.callbackContext.hasCancelCallback?new Br(this,e,t):null},t.matches=function(t){return t instanceof e&&(!t.callbackContext||!this.callbackContext||t.callbackContext.matches(this.callbackContext))},t.hasAnyCallback=function(){return null!==this.callbackContext},e}(),eo=function(){function e(e,t){this.eventType=e,this.callbackContext=t}var t=e.prototype;return t.respondsTo=function(e){var t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t},t.createCancelEvent=function(e,t){return this.callbackContext.hasCancelCallback?new Br(this,e,t):null},t.createEvent=function(e,t){p(null!=e.childName,"Child events should have a childName.");var n=Jr(new Qr(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new Yr(e.type,this,new $r(e.snapshotNode,n,i),e.prevName)},t.getEventRunner=function(e){var t=this;return"cancel"===e.getEventType()?function(){return t.callbackContext.onCancel(e.error)}:function(){return t.callbackContext.onValue(e.snapshot,e.prevName)}},t.matches=function(t){return t instanceof e&&(this.eventType===t.eventType&&(!this.callbackContext||!t.callbackContext||this.callbackContext.matches(t.callbackContext)))},t.hasAnyCallback=function(){return!!this.callbackContext},e}();!function(e){p(!ii,"__referenceConstructor has already been defined"),ii=e}(Qr),function(e){p(!hi,"__referenceConstructor has already been defined"),hi=e}(Qr);
/**
      * @license
      * Copyright 2020 Google LLC
      *
      ...
      * limitations under the License.
      */
var to={};function no(e,t,n,i,r){var o=i||e.options.databaseURL;void 0===o&&(e.options.projectId||se("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),ie("Using default host for project ",e.options.projectId),o=e.options.projectId+"-default-rtdb.firebaseio.com");var s,a=jr(o,r),u=a.repoInfo,l=void 0;"undefined"!=typeof process&&process.env&&(l=process.env.FIREBASE_DATABASE_EMULATOR_HOST),l?(s=!0,o="http://"+l+"?ns="+u.namespace,u=(a=jr(o,r)).repoInfo):s=!a.repoInfo.secure;var h=r&&s?new ke(ke.OWNER):new Ie(e.name,e.options,t);dr("Invalid Firebase Database URL",a),tt(a.path)||se("Database URL must point to the root of a Firebase Database (not including a child path).");var c=function(e,t,n,i){var r=to[t.name];r||(r={},to[t.name]=r);var o=r[e.toURLString()];o&&se("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return o=new yr(e,false,n,i),r[e.toURLString()]=o,o}(u,e,h,new Te(e.name,n));return new ro(c,e)}var io,ro=e("Database",function(){function e(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}var t=e.prototype;return t._delete=function(){var e,t,n;return null!==this._rootInternal&&(e=this._repo,t=this.app.name,(n=to[t])&&n[e.key]===e||se("Database "+t+"("+e.repoInfo_+") has already been deleted."),function(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}(e),delete n[e.key],this._repoInternal=null,this._rootInternal=null),Promise.resolve()},t._checkNotDeleted=function(e){null===this._rootInternal&&se("Cannot call "+e+" on a deleted database.")},i(e,[{key:"_repo",get:function(){return this._instanceStarted||(Cr(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}},{key:"_root",get:function(){return this._rootInternal||(this._rootInternal=new Qr(this._repo,Ke())),this._rootInternal}}]),e}());function oo(e,t,n,i){void 0===i&&(i={}),(e=b(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&se("Cannot call useEmulator() after instance has already been initialized.");var r=e._repoInternal,o=void 0;if(r.repoInfo_.nodeAdmin)i.mockUserToken&&se('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new ke(ke.OWNER);else if(i.mockUserToken){var s="string"==typeof i.mockUserToken?i.mockUserToken:S(i.mockUserToken,e.app.options.projectId);o=new ke(s)}!function(e,t,n,i){e.repoInfo_=new Ne(t+":"+n,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0),i&&(e.authTokenProvider_=i)}(r,t,n,o)}
/**
      * @license
      * Copyright 2021 Google LLC
      *
      ...
      * See the License for the specific language governing permissions and
      * limitations under the License.
      */ht.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},ht.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},z(c),l(new d("database",(function(e,t){var n=t.instanceIdentifier;return no(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),n)}),"PUBLIC").setMultipleInstances(!0)),h(U,j,io),h(U,j,"esm2017")}}}));

System.register("chunks:///_virtual/index.esm20172.js",["./rollupPluginModLoBabelHelpers.js","./index.esm20173.js","./index.esm20174.js","./index.esm20175.js","./index.js"],(function(e){var t,r,a,n,i,s,o,c,u,p,h,f,b,l,d;return{setters:[function(e){t=e.createForOfIteratorHelperLoose,r=e.createClass,a=e.asyncToGenerator,n=e.regeneratorRuntime},function(e){i=e.ComponentContainer,s=e.Component},function(e){o=e.Logger},function(t){c=t.getDefaultAppConfig,u=t.deepEqual,p=t.ErrorFactory,h=t.base64urlEncodeWithoutPadding,f=t.validateIndexedDBOpenable,b=t.isIndexedDBAvailable,l=t.FirebaseError,e("FirebaseError",t.FirebaseError)},function(e){d=e.openDB}],execute:function(){var m,g;
/**
       * @license
       * Copyright 2019 Google LLC
       *
